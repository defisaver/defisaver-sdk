[@defisaver/sdk](../README.md) / [Exports](../modules.md) / SubInputsAction

# Class: SubInputsAction
...
- [constructor](SubInputsAction.md#constructor)

### Properties

- [args](SubInputsAction.md#args)
- [contractAddress](SubInputsAction.md#contractaddress)
- [mappableArgs](SubInputsAction.md#mappableargs)
- [name](SubInputsAction.md#name)
- [paramTypes](SubInputsAction.md#paramtypes)

### Methods

- [\_encodeForCall](SubInputsAction.md#_encodeforcall)
- [\_formatType](SubInputsAction.md#_formattype)
- [\_getArgumentMapping](SubInputsAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](SubInputsAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](SubInputsAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](SubInputsAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](SubInputsAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](SubInputsAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](SubInputsAction.md#encodeforl2recipe)
- [encodeForRecipe](SubInputsAction.md#encodeforrecipe)
- [encodeForStrategy](SubInputsAction.md#encodeforstrategy)
- [getAccessList](SubInputsAction.md#getaccesslist)
- [getAssetsToApprove](SubInputsAction.md#getassetstoapprove)
- [getEthValue](SubInputsAction.md#getethvalue)
- [getId](SubInputsAction.md#getid)

## Constructors

### constructor

• **new SubInputsAction**(`a`, `b`)
...
[src/actions/basic/SubInputsAction.ts:11](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/SubInputsAction.ts#L11)
