[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityOpenAction

# Class: LiquityOpenAction
...
- [constructor](LiquityOpenAction.md#constructor)

### Properties

- [args](LiquityOpenAction.md#args)
- [contractAddress](LiquityOpenAction.md#contractaddress)
- [mappableArgs](LiquityOpenAction.md#mappableargs)
- [name](LiquityOpenAction.md#name)
- [paramTypes](LiquityOpenAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityOpenAction.md#_encodeforcall)
- [\_formatType](LiquityOpenAction.md#_formattype)
- [\_getArgumentMapping](LiquityOpenAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityOpenAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityOpenAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityOpenAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityOpenAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityOpenAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityOpenAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityOpenAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityOpenAction.md#encodeforstrategy)
- [getAccessList](LiquityOpenAction.md#getaccesslist)
- [getAssetsToApprove](LiquityOpenAction.md#getassetstoapprove)
- [getEthValue](LiquityOpenAction.md#getethvalue)
- [getId](LiquityOpenAction.md#getid)

## Constructors

### constructor

• **new LiquityOpenAction**(`maxFeePercentage`, `collAmount`, `lusdAmount`, `from`, `to`, `upperHint`, `lowerHint`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `maxFeePercentage` | `string` | Highest borrowing fee to accept |
| `collAmount` | `string` | Amount of WETH tokens to deposit as collateral |
| `lusdAmount` | `string` | Amount of LUSD tokens to borrow |
| `from` | `string` | Address where the tokens are pulled from |
| `to` | `string` | Address that will receive borrowed tokens |
| `upperHint` | `string` | - |
| `lowerHint` | `string` | - |
...
[src/actions/liquity/LiquityOpenAction.ts:20](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquityOpenAction.ts#L20)
...
[src/actions/liquity/LiquityOpenAction.ts:37](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquityOpenAction.ts#L37)
