[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3SupplyAction

# Class: AaveV3SupplyAction
...
- [constructor](AaveV3SupplyAction.md#constructor)

### Properties

- [args](AaveV3SupplyAction.md#args)
- [contractAddress](AaveV3SupplyAction.md#contractaddress)
- [mappableArgs](AaveV3SupplyAction.md#mappableargs)
- [name](AaveV3SupplyAction.md#name)
- [paramTypes](AaveV3SupplyAction.md#paramtypes)
- [tokenForApproval](AaveV3SupplyAction.md#tokenforapproval)

### Methods

- [\_encodeForCall](AaveV3SupplyAction.md#_encodeforcall)
- [\_formatType](AaveV3SupplyAction.md#_formattype)
- [\_getArgumentMapping](AaveV3SupplyAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV3SupplyAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV3SupplyAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV3SupplyAction.md#_replacewithplaceholders)
- [addressToBytes20](AaveV3SupplyAction.md#addresstobytes20)
- [boolToBytes1](AaveV3SupplyAction.md#booltobytes1)
- [encodeForDsProxyCall](AaveV3SupplyAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV3SupplyAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV3SupplyAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveV3SupplyAction.md#encodeforrecipe)
- [encodeForStrategy](AaveV3SupplyAction.md#encodeforstrategy)
- [encodeInputs](AaveV3SupplyAction.md#encodeinputs)
- [getAccessList](AaveV3SupplyAction.md#getaccesslist)
- [getAssetsToApprove](AaveV3SupplyAction.md#getassetstoapprove)
- [getEthValue](AaveV3SupplyAction.md#getethvalue)
- [getId](AaveV3SupplyAction.md#getid)
- [numberToBytes1](AaveV3SupplyAction.md#numbertobytes1)
- [numberToBytes2](AaveV3SupplyAction.md#numbertobytes2)
- [numberToBytes32](AaveV3SupplyAction.md#numbertobytes32)

## Constructors

### constructor

• **new AaveV3SupplyAction**(`useDefaultMarket`, `market`, `amount`, `from`, `tokenAddress`, `assetId`, `enableAsColl`, `useOnBehalf`, `onBehalf?`)
...
| `amount` | `string` | {string} Amount of tokens to be deposited |
| `from` | `string` | {EthAddress} Tokens will be supplied from this address |
| `tokenAddress` | `string` | {EthAddress} Address of the token |
| `assetId` | `string` | {number} The id of the token to be deposited |
| `enableAsColl` | `boolean` | {boolean} If we need to enable asset as collateral |
| `useOnBehalf` | `boolean` | {boolean} use on behalf param or default to proxy |
| `onBehalf?` | `string` | {EthAddress} For what user we are supplying the tokens, defaults to proxy |
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:26](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SupplyAction.ts#L26)
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:13](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SupplyAction.ts#L13)
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:51](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SupplyAction.ts#L51)
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:45](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SupplyAction.ts#L45)
