...
| `amount` | `string` | Amount of tokens to be deposited |
| `from` | `string` | Tokens will be supplied from this address |
| `tokenAddress` | `string` | Address of the token |
| `assetId` | `string` | The id of the token to be deposited |
| `enableAsColl` | `boolean` | If we need to enable asset as collateral |
| `useOnBehalf` | `boolean` | use on behalf param or default to proxy |
| `onBehalf` | `string` | For what user we are supplying the tokens, defaults to proxy |
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:26](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3SupplyAction.ts#L26)
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:13](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3SupplyAction.ts#L13)
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:51](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3SupplyAction.ts#L51)
...
[src/actions/aaveV3/AaveV3SupplyAction.ts:45](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3SupplyAction.ts#L45)
