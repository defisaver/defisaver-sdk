...
| :------ | :------ | :------ |
| `fundManager` | `string` | fundManager for the pool which we want to deposit into |
| `stablecoinAddress` | `string` | stablecoin token address |
| `poolTokenAddress` | `string` | poolTokenAddress |
| `amount` | `string` | amount of stablecoin to pull and deposit |
| `from` | `string` | stablecoins will be taken from this address |
| `to` | `string` | RSPT will be sent to this address |
...
[src/actions/rari/RariDepositAction.ts:20](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/rari/RariDepositAction.ts#L20)
...
[src/actions/rari/RariDepositAction.ts:30](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/rari/RariDepositAction.ts#L30)
