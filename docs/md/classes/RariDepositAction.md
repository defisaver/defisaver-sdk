[@defisaver/sdk](../README.md) / [Exports](../modules.md) / RariDepositAction

# Class: RariDepositAction
...
- [constructor](RariDepositAction.md#constructor)

### Properties

- [args](RariDepositAction.md#args)
- [contractAddress](RariDepositAction.md#contractaddress)
- [mappableArgs](RariDepositAction.md#mappableargs)
- [name](RariDepositAction.md#name)
- [paramTypes](RariDepositAction.md#paramtypes)

### Methods

- [\_encodeForCall](RariDepositAction.md#_encodeforcall)
- [\_formatType](RariDepositAction.md#_formattype)
- [\_getArgumentMapping](RariDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](RariDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](RariDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](RariDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](RariDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](RariDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](RariDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](RariDepositAction.md#encodeforrecipe)
- [encodeForStrategy](RariDepositAction.md#encodeforstrategy)
- [getAccessList](RariDepositAction.md#getaccesslist)
- [getAssetsToApprove](RariDepositAction.md#getassetstoapprove)
- [getEthValue](RariDepositAction.md#getethvalue)
- [getId](RariDepositAction.md#getid)
...
| :------ | :------ | :------ |
| `fundManager` | `string` | {EthAddress} fundManager for the pool which we want to deposit into |
| `stablecoinAddress` | `string` | {EthAddress} stablecoin token address |
| `poolTokenAddress` | `string` | {EthAddress} poolTokenAddress |
| `amount` | `string` | {string} amount of stablecoin to pull and deposit |
| `from` | `string` | {EthAddress} stablecoins will be taken from this address |
| `to` | `string` | {EthAddress} RSPT will be sent to this address |
...
[src/actions/rari/RariDepositAction.ts:20](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/rari/RariDepositAction.ts#L20)
...
[src/actions/rari/RariDepositAction.ts:30](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/rari/RariDepositAction.ts#L30)
