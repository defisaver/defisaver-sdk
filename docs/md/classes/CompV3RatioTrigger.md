[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompV3RatioTrigger

# Class: CompV3RatioTrigger
...
- [constructor](CompV3RatioTrigger.md#constructor)

### Properties

- [args](CompV3RatioTrigger.md#args)
- [contractAddress](CompV3RatioTrigger.md#contractaddress)
- [mappableArgs](CompV3RatioTrigger.md#mappableargs)
- [name](CompV3RatioTrigger.md#name)
- [paramTypes](CompV3RatioTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](CompV3RatioTrigger.md#_encodeforcall)
- [\_formatType](CompV3RatioTrigger.md#_formattype)
- [\_getArgumentMapping](CompV3RatioTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompV3RatioTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompV3RatioTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompV3RatioTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompV3RatioTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompV3RatioTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompV3RatioTrigger.md#encodeforl2recipe)
- [encodeForRecipe](CompV3RatioTrigger.md#encodeforrecipe)
- [encodeForStrategy](CompV3RatioTrigger.md#encodeforstrategy)
- [getAccessList](CompV3RatioTrigger.md#getaccesslist)
- [getAssetsToApprove](CompV3RatioTrigger.md#getassetstoapprove)
- [getEthValue](CompV3RatioTrigger.md#getethvalue)
- [getId](CompV3RatioTrigger.md#getid)

## Constructors

### constructor

• **new CompV3RatioTrigger**(`user`, `market`, `ratio`, `state`)
...
[src/triggers/CompV3RatioTrigger.ts:12](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/CompV3RatioTrigger.ts#L12)
