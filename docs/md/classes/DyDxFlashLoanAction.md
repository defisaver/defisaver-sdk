[@defisaver/sdk](../README.md) / [Exports](../modules.md) / DyDxFlashLoanAction

# Class: DyDxFlashLoanAction
...
- [constructor](DyDxFlashLoanAction.md#constructor)

### Properties

- [args](DyDxFlashLoanAction.md#args)
- [contractAddress](DyDxFlashLoanAction.md#contractaddress)
- [mappableArgs](DyDxFlashLoanAction.md#mappableargs)
- [name](DyDxFlashLoanAction.md#name)
- [paramTypes](DyDxFlashLoanAction.md#paramtypes)

### Methods

- [\_encodeForCall](DyDxFlashLoanAction.md#_encodeforcall)
- [\_formatType](DyDxFlashLoanAction.md#_formattype)
- [\_getArgumentMapping](DyDxFlashLoanAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](DyDxFlashLoanAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](DyDxFlashLoanAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](DyDxFlashLoanAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](DyDxFlashLoanAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](DyDxFlashLoanAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](DyDxFlashLoanAction.md#encodeforl2recipe)
- [encodeForRecipe](DyDxFlashLoanAction.md#encodeforrecipe)
- [encodeForStrategy](DyDxFlashLoanAction.md#encodeforstrategy)
- [getAccessList](DyDxFlashLoanAction.md#getaccesslist)
- [getAssetsToApprove](DyDxFlashLoanAction.md#getassetstoapprove)
- [getEthValue](DyDxFlashLoanAction.md#getethvalue)
- [getId](DyDxFlashLoanAction.md#getid)
...
| :------ | :------ | :------ | :------ |
| `loanAmount` | `string` | `undefined` | {string} |
...
[src/actions/flashloan/DyDxFlashLoanAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/flashloan/DyDxFlashLoanAction.ts#L17)
