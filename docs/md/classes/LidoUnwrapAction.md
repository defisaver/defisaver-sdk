...
| :------ | :------ | :------ |
| `amount` | `string` | {string} amount of WStEth to pull and Unwrap |
| `from` | `string` | {EthAddress} WstEth will be taken from this address |
...
[src/actions/lido/LidoUnwrapAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/lido/LidoUnwrapAction.ts#L17)
...
[src/actions/lido/LidoUnwrapAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/lido/LidoUnwrapAction.ts#L22)
