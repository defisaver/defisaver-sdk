[@defisaver/sdk](../README.md) / [Exports](../modules.md) / BalancerFlashLoanAction

# Class: BalancerFlashLoanAction
...
- [constructor](BalancerFlashLoanAction.md#constructor)

### Properties

- [args](BalancerFlashLoanAction.md#args)
- [contractAddress](BalancerFlashLoanAction.md#contractaddress)
- [mappableArgs](BalancerFlashLoanAction.md#mappableargs)
- [name](BalancerFlashLoanAction.md#name)
- [paramTypes](BalancerFlashLoanAction.md#paramtypes)

### Methods

- [\_encodeForCall](BalancerFlashLoanAction.md#_encodeforcall)
- [\_formatType](BalancerFlashLoanAction.md#_formattype)
- [\_getArgumentMapping](BalancerFlashLoanAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](BalancerFlashLoanAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](BalancerFlashLoanAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](BalancerFlashLoanAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](BalancerFlashLoanAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](BalancerFlashLoanAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](BalancerFlashLoanAction.md#encodeforl2recipe)
- [encodeForRecipe](BalancerFlashLoanAction.md#encodeforrecipe)
- [encodeForStrategy](BalancerFlashLoanAction.md#encodeforstrategy)
- [getAccessList](BalancerFlashLoanAction.md#getaccesslist)
- [getAssetsToApprove](BalancerFlashLoanAction.md#getassetstoapprove)
- [getEthValue](BalancerFlashLoanAction.md#getethvalue)
- [getId](BalancerFlashLoanAction.md#getid)
...
| :------ | :------ | :------ | :------ |
| `tokens` | `string`[] | `undefined` | {EthAddress[]} |
| `amounts` | `string`[] | `undefined` | {string[]} |
...
[src/actions/flashloan/BalancerFlashLoanAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/flashloan/BalancerFlashLoanAction.ts#L17)
