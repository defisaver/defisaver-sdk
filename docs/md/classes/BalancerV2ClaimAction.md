[@defisaver/sdk](../README.md) / [Exports](../modules.md) / BalancerV2ClaimAction

# Class: BalancerV2ClaimAction
...
- [constructor](BalancerV2ClaimAction.md#constructor)

### Properties

- [args](BalancerV2ClaimAction.md#args)
- [contractAddress](BalancerV2ClaimAction.md#contractaddress)
- [mappableArgs](BalancerV2ClaimAction.md#mappableargs)
- [name](BalancerV2ClaimAction.md#name)
- [paramTypes](BalancerV2ClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](BalancerV2ClaimAction.md#_encodeforcall)
- [\_formatType](BalancerV2ClaimAction.md#_formattype)
- [\_getArgumentMapping](BalancerV2ClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](BalancerV2ClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](BalancerV2ClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](BalancerV2ClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](BalancerV2ClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](BalancerV2ClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](BalancerV2ClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](BalancerV2ClaimAction.md#encodeforrecipe)
- [encodeForStrategy](BalancerV2ClaimAction.md#encodeforstrategy)
- [getAccessList](BalancerV2ClaimAction.md#getaccesslist)
- [getAssetsToApprove](BalancerV2ClaimAction.md#getassetstoapprove)
- [getEthValue](BalancerV2ClaimAction.md#getethvalue)
- [getId](BalancerV2ClaimAction.md#getid)
...
[src/actions/balancer/BalancerV2ClaimAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/balancer/BalancerV2ClaimAction.ts#L18)
...
[src/actions/balancer/BalancerV2ClaimAction.ts:39](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/balancer/BalancerV2ClaimAction.ts#L39)
