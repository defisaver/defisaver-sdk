[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundV3TransferAction

# Class: CompoundV3TransferAction
...
- [constructor](CompoundV3TransferAction.md#constructor)

### Properties

- [args](CompoundV3TransferAction.md#args)
- [contractAddress](CompoundV3TransferAction.md#contractaddress)
- [mappableArgs](CompoundV3TransferAction.md#mappableargs)
- [name](CompoundV3TransferAction.md#name)
- [paramTypes](CompoundV3TransferAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundV3TransferAction.md#_encodeforcall)
- [\_formatType](CompoundV3TransferAction.md#_formattype)
- [\_getArgumentMapping](CompoundV3TransferAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundV3TransferAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundV3TransferAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundV3TransferAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundV3TransferAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundV3TransferAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundV3TransferAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundV3TransferAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundV3TransferAction.md#encodeforstrategy)
- [getAccessList](CompoundV3TransferAction.md#getaccesslist)
- [getAssetsToApprove](CompoundV3TransferAction.md#getassetstoapprove)
- [getEthValue](CompoundV3TransferAction.md#getethvalue)
- [getId](CompoundV3TransferAction.md#getid)

## Constructors

### constructor

• **new CompoundV3TransferAction**(`market`, `from`, `to`, `asset`, `amount`)
...
| `from` | `string` | {EthAddress} address of src |
| `to` | `string` | {EthAddress} address of dst |
| `asset` | `string` | {EthAddress} address of ERC20 token |
| `amount` | `string` | {uint256} amount of assets to be transferred |
...
[src/actions/compoundV3/CompoundV3TransferAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compoundV3/CompoundV3TransferAction.ts#L19)
