...
| `from` | `string` | address of src |
| `to` | `string` | address of dst |
| `asset` | `string` | address of ERC20 token |
| `amount` | `string` | amount of assets to be transferred |
...
[src/actions/compoundV3/CompoundV3TransferAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3TransferAction.ts#L19)
