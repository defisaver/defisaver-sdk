...
| `from` | `string` |  |
| `onBehalf` | `string` | Defaults to DsProxy address if 0x0 |
...
[src/actions/compound/CompoundPaybackAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundPaybackAction.ts#L18)
...
[src/actions/compound/CompoundPaybackAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundPaybackAction.ts#L22)
