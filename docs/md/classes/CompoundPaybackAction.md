[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundPaybackAction

# Class: CompoundPaybackAction
...
- [constructor](CompoundPaybackAction.md#constructor)

### Properties

- [args](CompoundPaybackAction.md#args)
- [contractAddress](CompoundPaybackAction.md#contractaddress)
- [mappableArgs](CompoundPaybackAction.md#mappableargs)
- [name](CompoundPaybackAction.md#name)
- [paramTypes](CompoundPaybackAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundPaybackAction.md#_encodeforcall)
- [\_formatType](CompoundPaybackAction.md#_formattype)
- [\_getArgumentMapping](CompoundPaybackAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundPaybackAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundPaybackAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundPaybackAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundPaybackAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundPaybackAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundPaybackAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundPaybackAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundPaybackAction.md#encodeforstrategy)
- [getAccessList](CompoundPaybackAction.md#getaccesslist)
- [getAssetsToApprove](CompoundPaybackAction.md#getassetstoapprove)
- [getEthValue](CompoundPaybackAction.md#getethvalue)
- [getId](CompoundPaybackAction.md#getid)
...
| `onBehalf` | `string` | {EthAddress} Defaults to DsProxy address if 0x0 |
...
[src/actions/compound/CompoundPaybackAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compound/CompoundPaybackAction.ts#L18)
...
[src/actions/compound/CompoundPaybackAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compound/CompoundPaybackAction.ts#L22)
