[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundClaimAction

# Class: CompoundClaimAction
...
- [constructor](CompoundClaimAction.md#constructor)

### Properties

- [args](CompoundClaimAction.md#args)
- [contractAddress](CompoundClaimAction.md#contractaddress)
- [mappableArgs](CompoundClaimAction.md#mappableargs)
- [name](CompoundClaimAction.md#name)
- [paramTypes](CompoundClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundClaimAction.md#_encodeforcall)
- [\_formatType](CompoundClaimAction.md#_formattype)
- [\_getArgumentMapping](CompoundClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundClaimAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundClaimAction.md#encodeforstrategy)
- [getAccessList](CompoundClaimAction.md#getaccesslist)
- [getAssetsToApprove](CompoundClaimAction.md#getassetstoapprove)
- [getEthValue](CompoundClaimAction.md#getethvalue)
- [getId](CompoundClaimAction.md#getid)
...
| :------ | :------ | :------ |
| `cSupplyAddresses` | `string`[] | {EthAddress[]} |
| `cBorrowAddresses` | `string`[] | {EthAddress[]} |
...
[src/actions/compound/CompoundClaimAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compound/CompoundClaimAction.ts#L18)
