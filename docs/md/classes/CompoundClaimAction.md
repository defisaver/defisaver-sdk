...
| Name | Type |
| :------ | :------ |
| `cSupplyAddresses` | `string`[] |
| `cBorrowAddresses` | `string`[] |
| `from` | `string` |
| `to` | `string` |
...
[src/actions/compound/CompoundClaimAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundClaimAction.ts#L18)
