[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityPaybackAction

# Class: LiquityPaybackAction
...
- [constructor](LiquityPaybackAction.md#constructor)

### Properties

- [args](LiquityPaybackAction.md#args)
- [contractAddress](LiquityPaybackAction.md#contractaddress)
- [mappableArgs](LiquityPaybackAction.md#mappableargs)
- [name](LiquityPaybackAction.md#name)
- [paramTypes](LiquityPaybackAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityPaybackAction.md#_encodeforcall)
- [\_formatType](LiquityPaybackAction.md#_formattype)
- [\_getArgumentMapping](LiquityPaybackAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityPaybackAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityPaybackAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityPaybackAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityPaybackAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityPaybackAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityPaybackAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityPaybackAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityPaybackAction.md#encodeforstrategy)
- [getAccessList](LiquityPaybackAction.md#getaccesslist)
- [getAssetsToApprove](LiquityPaybackAction.md#getassetstoapprove)
- [getEthValue](LiquityPaybackAction.md#getethvalue)
- [getId](LiquityPaybackAction.md#getid)

## Constructors

### constructor

• **new LiquityPaybackAction**(`lusdAmount`, `from`, `upperHint`, `lowerHint`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `lusdAmount` | `string` | Amount of LUSD tokens to repay |
...
[src/actions/liquity/LiquityPaybackAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquityPaybackAction.ts#L17)
...
[src/actions/liquity/LiquityPaybackAction.ts:30](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquityPaybackAction.ts#L30)
