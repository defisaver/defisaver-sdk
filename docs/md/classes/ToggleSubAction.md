[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ToggleSubAction

# Class: ToggleSubAction
...
- [constructor](ToggleSubAction.md#constructor)

### Properties

- [args](ToggleSubAction.md#args)
- [contractAddress](ToggleSubAction.md#contractaddress)
- [mappableArgs](ToggleSubAction.md#mappableargs)
- [name](ToggleSubAction.md#name)
- [paramTypes](ToggleSubAction.md#paramtypes)

### Methods

- [\_encodeForCall](ToggleSubAction.md#_encodeforcall)
- [\_formatType](ToggleSubAction.md#_formattype)
- [\_getArgumentMapping](ToggleSubAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ToggleSubAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ToggleSubAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ToggleSubAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ToggleSubAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ToggleSubAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ToggleSubAction.md#encodeforl2recipe)
- [encodeForRecipe](ToggleSubAction.md#encodeforrecipe)
- [encodeForStrategy](ToggleSubAction.md#encodeforstrategy)
- [getAccessList](ToggleSubAction.md#getaccesslist)
- [getAssetsToApprove](ToggleSubAction.md#getassetstoapprove)
- [getEthValue](ToggleSubAction.md#getethvalue)
- [getId](ToggleSubAction.md#getid)
...
| :------ | :------ | :------ |
| `subId` | `string` | Id of the subscription in the SubStorage contract |
| `active` | `boolean` | Set to true to activate action, to false to deactivate |
...
[src/actions/basic/ToggleSubAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/ToggleSubAction.ts#L15)
