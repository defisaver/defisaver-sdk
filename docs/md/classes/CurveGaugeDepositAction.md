[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveGaugeDepositAction

# Class: CurveGaugeDepositAction
...
- [constructor](CurveGaugeDepositAction.md#constructor)

### Properties

- [args](CurveGaugeDepositAction.md#args)
- [contractAddress](CurveGaugeDepositAction.md#contractaddress)
- [mappableArgs](CurveGaugeDepositAction.md#mappableargs)
- [name](CurveGaugeDepositAction.md#name)
- [paramTypes](CurveGaugeDepositAction.md#paramtypes)

### Methods

- [\_encodeForCall](CurveGaugeDepositAction.md#_encodeforcall)
- [\_formatType](CurveGaugeDepositAction.md#_formattype)
- [\_getArgumentMapping](CurveGaugeDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveGaugeDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveGaugeDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveGaugeDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveGaugeDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveGaugeDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveGaugeDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveGaugeDepositAction.md#encodeforrecipe)
- [encodeForStrategy](CurveGaugeDepositAction.md#encodeforstrategy)
- [getAccessList](CurveGaugeDepositAction.md#getaccesslist)
- [getAssetsToApprove](CurveGaugeDepositAction.md#getassetstoapprove)
- [getEthValue](CurveGaugeDepositAction.md#getethvalue)
- [getId](CurveGaugeDepositAction.md#getid)
...
[src/actions/curve/CurveGaugeDepositAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/curve/CurveGaugeDepositAction.ts#L19)
...
[src/actions/curve/CurveGaugeDepositAction.ts:35](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/curve/CurveGaugeDepositAction.ts#L35)
