[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CBChickenOutAction

# Class: CBChickenOutAction
...
- [constructor](CBChickenOutAction.md#constructor)

### Properties

- [args](CBChickenOutAction.md#args)
- [contractAddress](CBChickenOutAction.md#contractaddress)
- [mappableArgs](CBChickenOutAction.md#mappableargs)
- [name](CBChickenOutAction.md#name)
- [paramTypes](CBChickenOutAction.md#paramtypes)

### Methods

- [\_encodeForCall](CBChickenOutAction.md#_encodeforcall)
- [\_formatType](CBChickenOutAction.md#_formattype)
- [\_getArgumentMapping](CBChickenOutAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CBChickenOutAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CBChickenOutAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CBChickenOutAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CBChickenOutAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CBChickenOutAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CBChickenOutAction.md#encodeforl2recipe)
- [encodeForRecipe](CBChickenOutAction.md#encodeforrecipe)
- [encodeForStrategy](CBChickenOutAction.md#encodeforstrategy)
- [getAccessList](CBChickenOutAction.md#getaccesslist)
- [getAssetsToApprove](CBChickenOutAction.md#getassetstoapprove)
- [getEthValue](CBChickenOutAction.md#getethvalue)
- [getId](CBChickenOutAction.md#getid)

## Constructors

### constructor

• **new CBChickenOutAction**(`bondId`, `minLUSD`, `to`)
...
| :------ | :------ | :------ |
| `bondId` | `string` | - |
| `minLUSD` | `string` | {string} Min amount of lusd to receive |
...
[src/actions/chickenBonds/CBChickenOutAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/chickenBonds/CBChickenOutAction.ts#L17)
