...
| :------ | :------ | :------ |
| `bondId` | `string` | - |
| `minLUSD` | `string` | Min amount of lusd to receive |
| `to` | `string` |  |
...
[src/actions/chickenBonds/CBChickenOutAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/chickenBonds/CBChickenOutAction.ts#L17)
