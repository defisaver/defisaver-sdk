...
| :------ | :------ | :------ |
| `vaultId` | `string` |  |
| `amount` | `string` | Amount of DAI to generate in wei |
| `to` | `string` | Generated DAI will be sent to this address |
| `mcdManager` | `string` |  |
...
[src/actions/maker/MakerGenerateAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/maker/MakerGenerateAction.ts#L18)
