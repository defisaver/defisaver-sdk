[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerGenerateAction

# Class: MakerGenerateAction
...
- [constructor](MakerGenerateAction.md#constructor)

### Properties

- [args](MakerGenerateAction.md#args)
- [contractAddress](MakerGenerateAction.md#contractaddress)
- [mappableArgs](MakerGenerateAction.md#mappableargs)
- [name](MakerGenerateAction.md#name)
- [paramTypes](MakerGenerateAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerGenerateAction.md#_encodeforcall)
- [\_formatType](MakerGenerateAction.md#_formattype)
- [\_getArgumentMapping](MakerGenerateAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerGenerateAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerGenerateAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerGenerateAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerGenerateAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerGenerateAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerGenerateAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerGenerateAction.md#encodeforrecipe)
- [encodeForStrategy](MakerGenerateAction.md#encodeforstrategy)
- [getAccessList](MakerGenerateAction.md#getaccesslist)
- [getAssetsToApprove](MakerGenerateAction.md#getassetstoapprove)
- [getEthValue](MakerGenerateAction.md#getethvalue)
- [getId](MakerGenerateAction.md#getid)
...
| `amount` | `string` | {string} Amount of DAI to generate in wei |
| `to` | `string` | {EthAddress} Generated DAI will be sent to this address |
...
[src/actions/maker/MakerGenerateAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerGenerateAction.ts#L18)
