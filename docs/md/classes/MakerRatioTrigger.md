[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerRatioTrigger

# Class: MakerRatioTrigger
...
- [constructor](MakerRatioTrigger.md#constructor)

### Properties

- [args](MakerRatioTrigger.md#args)
- [contractAddress](MakerRatioTrigger.md#contractaddress)
- [mappableArgs](MakerRatioTrigger.md#mappableargs)
- [name](MakerRatioTrigger.md#name)
- [paramTypes](MakerRatioTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](MakerRatioTrigger.md#_encodeforcall)
- [\_formatType](MakerRatioTrigger.md#_formattype)
- [\_getArgumentMapping](MakerRatioTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerRatioTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerRatioTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerRatioTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerRatioTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerRatioTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerRatioTrigger.md#encodeforl2recipe)
- [encodeForRecipe](MakerRatioTrigger.md#encodeforrecipe)
- [encodeForStrategy](MakerRatioTrigger.md#encodeforstrategy)
- [getAccessList](MakerRatioTrigger.md#getaccesslist)
- [getAssetsToApprove](MakerRatioTrigger.md#getassetstoapprove)
- [getEthValue](MakerRatioTrigger.md#getethvalue)
- [getId](MakerRatioTrigger.md#getid)

## Constructors

### constructor

• **new MakerRatioTrigger**(`vaultId`, `ratio`, `state`)
...
[src/triggers/MakerRatioTrigger.ts:13](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/triggers/MakerRatioTrigger.ts#L13)
