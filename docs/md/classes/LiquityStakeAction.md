[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityStakeAction

# Class: LiquityStakeAction
...
- [constructor](LiquityStakeAction.md#constructor)

### Properties

- [args](LiquityStakeAction.md#args)
- [contractAddress](LiquityStakeAction.md#contractaddress)
- [mappableArgs](LiquityStakeAction.md#mappableargs)
- [name](LiquityStakeAction.md#name)
- [paramTypes](LiquityStakeAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityStakeAction.md#_encodeforcall)
- [\_formatType](LiquityStakeAction.md#_formattype)
- [\_getArgumentMapping](LiquityStakeAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityStakeAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityStakeAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityStakeAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityStakeAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityStakeAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityStakeAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityStakeAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityStakeAction.md#encodeforstrategy)
- [getAccessList](LiquityStakeAction.md#getaccesslist)
- [getAssetsToApprove](LiquityStakeAction.md#getassetstoapprove)
- [getEthValue](LiquityStakeAction.md#getethvalue)
- [getId](LiquityStakeAction.md#getid)
...
| :------ | :------ | :------ |
| `lqtyAmount` | `string` | Amount of LQTY tokens that will be staked |
...
[src/actions/liquity/LiquityStakeAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquityStakeAction.ts#L19)
...
[src/actions/liquity/LiquityStakeAction.ts:36](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquityStakeAction.ts#L36)
