[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundRatioTrigger

# Class: CompoundRatioTrigger
...
- [constructor](CompoundRatioTrigger.md#constructor)

### Properties

- [args](CompoundRatioTrigger.md#args)
- [contractAddress](CompoundRatioTrigger.md#contractaddress)
- [mappableArgs](CompoundRatioTrigger.md#mappableargs)
- [name](CompoundRatioTrigger.md#name)
- [paramTypes](CompoundRatioTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundRatioTrigger.md#_encodeforcall)
- [\_formatType](CompoundRatioTrigger.md#_formattype)
- [\_getArgumentMapping](CompoundRatioTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundRatioTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundRatioTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundRatioTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundRatioTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundRatioTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundRatioTrigger.md#encodeforl2recipe)
- [encodeForRecipe](CompoundRatioTrigger.md#encodeforrecipe)
- [encodeForStrategy](CompoundRatioTrigger.md#encodeforstrategy)
- [getAccessList](CompoundRatioTrigger.md#getaccesslist)
- [getAssetsToApprove](CompoundRatioTrigger.md#getassetstoapprove)
- [getEthValue](CompoundRatioTrigger.md#getethvalue)
- [getId](CompoundRatioTrigger.md#getid)

## Constructors

### constructor

• **new CompoundRatioTrigger**(`user`, `ratio`, `state`)
...
[src/triggers/CompoundRatioTrigger.ts:12](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/CompoundRatioTrigger.ts#L12)
