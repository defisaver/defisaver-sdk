[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerMergeAction

# Class: MakerMergeAction
...
- [constructor](MakerMergeAction.md#constructor)

### Properties

- [args](MakerMergeAction.md#args)
- [contractAddress](MakerMergeAction.md#contractaddress)
- [mappableArgs](MakerMergeAction.md#mappableargs)
- [name](MakerMergeAction.md#name)
- [paramTypes](MakerMergeAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerMergeAction.md#_encodeforcall)
- [\_formatType](MakerMergeAction.md#_formattype)
- [\_getArgumentMapping](MakerMergeAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerMergeAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerMergeAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerMergeAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerMergeAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerMergeAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerMergeAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerMergeAction.md#encodeforrecipe)
- [encodeForStrategy](MakerMergeAction.md#encodeforstrategy)
- [getAccessList](MakerMergeAction.md#getaccesslist)
- [getAssetsToApprove](MakerMergeAction.md#getassetstoapprove)
- [getEthValue](MakerMergeAction.md#getethvalue)
- [getId](MakerMergeAction.md#getid)
...
| :------ | :------ | :------ |
| `srcVaultId` | `string` | {VaultId} |
| `destVaultId` | `string` | {VaultId} |
...
[src/actions/maker/MakerMergeAction.ts:16](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerMergeAction.ts#L16)
