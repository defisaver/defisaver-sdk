[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ConvexDepositAction

# Class: ConvexDepositAction
...
- [constructor](ConvexDepositAction.md#constructor)

### Properties

- [args](ConvexDepositAction.md#args)
- [contractAddress](ConvexDepositAction.md#contractaddress)
- [curveLp](ConvexDepositAction.md#curvelp)
- [mappableArgs](ConvexDepositAction.md#mappableargs)
- [name](ConvexDepositAction.md#name)
- [paramTypes](ConvexDepositAction.md#paramtypes)

### Methods

- [\_encodeForCall](ConvexDepositAction.md#_encodeforcall)
- [\_formatType](ConvexDepositAction.md#_formattype)
- [\_getArgumentMapping](ConvexDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ConvexDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ConvexDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ConvexDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ConvexDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ConvexDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ConvexDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](ConvexDepositAction.md#encodeforrecipe)
- [encodeForStrategy](ConvexDepositAction.md#encodeforstrategy)
- [getAccessList](ConvexDepositAction.md#getaccesslist)
- [getAssetsToApprove](ConvexDepositAction.md#getassetstoapprove)
- [getEthValue](ConvexDepositAction.md#getethvalue)
- [getId](ConvexDepositAction.md#getid)

## Constructors

### constructor

• **new ConvexDepositAction**(`from`, `to`, `curveLp`, `amount`, `option`)
...
[src/actions/convex/ConvexDepositAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/convex/ConvexDepositAction.ts#L22)
...
[src/actions/convex/ConvexDepositAction.ts:13](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/convex/ConvexDepositAction.ts#L13)
...
[src/actions/convex/ConvexDepositAction.ts:61](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/convex/ConvexDepositAction.ts#L61)
