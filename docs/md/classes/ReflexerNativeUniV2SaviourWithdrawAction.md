[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ReflexerNativeUniV2SaviourWithdrawAction

# Class: ReflexerNativeUniV2SaviourWithdrawAction
...
- [constructor](ReflexerNativeUniV2SaviourWithdrawAction.md#constructor)

### Properties

- [args](ReflexerNativeUniV2SaviourWithdrawAction.md#args)
- [contractAddress](ReflexerNativeUniV2SaviourWithdrawAction.md#contractaddress)
- [mappableArgs](ReflexerNativeUniV2SaviourWithdrawAction.md#mappableargs)
- [name](ReflexerNativeUniV2SaviourWithdrawAction.md#name)
- [paramTypes](ReflexerNativeUniV2SaviourWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](ReflexerNativeUniV2SaviourWithdrawAction.md#_encodeforcall)
- [\_formatType](ReflexerNativeUniV2SaviourWithdrawAction.md#_formattype)
- [\_getArgumentMapping](ReflexerNativeUniV2SaviourWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ReflexerNativeUniV2SaviourWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ReflexerNativeUniV2SaviourWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ReflexerNativeUniV2SaviourWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ReflexerNativeUniV2SaviourWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ReflexerNativeUniV2SaviourWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ReflexerNativeUniV2SaviourWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](ReflexerNativeUniV2SaviourWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](ReflexerNativeUniV2SaviourWithdrawAction.md#encodeforstrategy)
- [getAccessList](ReflexerNativeUniV2SaviourWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](ReflexerNativeUniV2SaviourWithdrawAction.md#getassetstoapprove)
- [getEthValue](ReflexerNativeUniV2SaviourWithdrawAction.md#getethvalue)
- [getId](ReflexerNativeUniV2SaviourWithdrawAction.md#getid)
...
[src/actions/reflexer/ReflexerNativeUniV2SaviourWithdrawAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/reflexer/ReflexerNativeUniV2SaviourWithdrawAction.ts#L17)
