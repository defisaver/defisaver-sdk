[@defisaver/sdk](../README.md) / [Exports](../modules.md) / UniswapWithdrawAction

# Class: UniswapWithdrawAction
...
- [constructor](UniswapWithdrawAction.md#constructor)

### Properties

- [args](UniswapWithdrawAction.md#args)
- [contractAddress](UniswapWithdrawAction.md#contractaddress)
- [mappableArgs](UniswapWithdrawAction.md#mappableargs)
- [name](UniswapWithdrawAction.md#name)
- [paramTypes](UniswapWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](UniswapWithdrawAction.md#_encodeforcall)
- [\_formatType](UniswapWithdrawAction.md#_formattype)
- [\_getArgumentMapping](UniswapWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](UniswapWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](UniswapWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](UniswapWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](UniswapWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](UniswapWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](UniswapWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](UniswapWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](UniswapWithdrawAction.md#encodeforstrategy)
- [getAccessList](UniswapWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](UniswapWithdrawAction.md#getassetstoapprove)
- [getEthValue](UniswapWithdrawAction.md#getethvalue)
- [getId](UniswapWithdrawAction.md#getid)
...
[src/actions/uniswap/UniswapWithdrawAction.ts:23](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/uniswap/UniswapWithdrawAction.ts#L23)
...
▸ **getAssetsToApprove**(): `Promise`<{ `asset`: `string` = lpAddress; `owner`: `any` ; `specialApproveLabel`: `string` = 'uniswap v2' }[]\>
...
`Promise`<{ `asset`: `string` = lpAddress; `owner`: `any` ; `specialApproveLabel`: `string` = 'uniswap v2' }[]\>
...
[src/actions/uniswap/UniswapWithdrawAction.ts:50](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/uniswap/UniswapWithdrawAction.ts#L50)
