[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveWithdrawAction

# Class: AaveWithdrawAction
...
- [constructor](AaveWithdrawAction.md#constructor)

### Properties

- [args](AaveWithdrawAction.md#args)
- [contractAddress](AaveWithdrawAction.md#contractaddress)
- [mappableArgs](AaveWithdrawAction.md#mappableargs)
- [name](AaveWithdrawAction.md#name)
- [paramTypes](AaveWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveWithdrawAction.md#_encodeforcall)
- [\_formatType](AaveWithdrawAction.md#_formattype)
- [\_getArgumentMapping](AaveWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](AaveWithdrawAction.md#encodeforstrategy)
- [getAccessList](AaveWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](AaveWithdrawAction.md#getassetstoapprove)
- [getEthValue](AaveWithdrawAction.md#getethvalue)
- [getId](AaveWithdrawAction.md#getid)
...
| `to` | `string` | Tokens will be withdrawn to this address |
...
[src/actions/aave/AaveWithdrawAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aave/AaveWithdrawAction.ts#L18)
