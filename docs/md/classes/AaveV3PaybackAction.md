...
| `amount` | `string` | {string} Amount of tokens to be payed back |
...
| `assetId` | `string` | {number} The id of the underlying asset to be repaid |
| `useOnBehalf` | `boolean` | {boolean} use on behalf param or default to proxy |
| `onBehalf` | `string` | {EthAddress} For what user we are paying back the debt, defaults to proxy |
...
[src/actions/aaveV3/AaveV3PaybackAction.ts:27](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3PaybackAction.ts#L27)
...
[src/actions/aaveV3/AaveV3PaybackAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3PaybackAction.ts#L14)
...
[src/actions/aaveV3/AaveV3PaybackAction.ts:52](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3PaybackAction.ts#L52)
...
[src/actions/aaveV3/AaveV3PaybackAction.ts:46](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3PaybackAction.ts#L46)
