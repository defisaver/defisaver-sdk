[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityBorrowAction

# Class: LiquityBorrowAction
...
- [constructor](LiquityBorrowAction.md#constructor)

### Properties

- [args](LiquityBorrowAction.md#args)
- [contractAddress](LiquityBorrowAction.md#contractaddress)
- [mappableArgs](LiquityBorrowAction.md#mappableargs)
- [name](LiquityBorrowAction.md#name)
- [paramTypes](LiquityBorrowAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityBorrowAction.md#_encodeforcall)
- [\_formatType](LiquityBorrowAction.md#_formattype)
- [\_getArgumentMapping](LiquityBorrowAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityBorrowAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityBorrowAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityBorrowAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityBorrowAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityBorrowAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityBorrowAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityBorrowAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityBorrowAction.md#encodeforstrategy)
- [getAccessList](LiquityBorrowAction.md#getaccesslist)
- [getAssetsToApprove](LiquityBorrowAction.md#getassetstoapprove)
- [getEthValue](LiquityBorrowAction.md#getethvalue)
- [getId](LiquityBorrowAction.md#getid)

## Constructors

### constructor

• **new LiquityBorrowAction**(`maxFeePercentage`, `lusdAmount`, `to`, `upperHint`, `lowerHint`)
...
| `to` | `string` | Address that will receive the borrowed tokens |
| `upperHint` | `string` | - |
| `lowerHint` | `string` | - |
...
[src/actions/liquity/LiquityBorrowAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquityBorrowAction.ts#L17)
