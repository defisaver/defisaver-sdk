[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundV3AllowAction
...
| `manager` | `string` | address of manager |
| `isAllowed` | `boolean` |  |
...
[src/actions/compoundV3/CompoundV3AllowAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3AllowAction.ts#L17)
