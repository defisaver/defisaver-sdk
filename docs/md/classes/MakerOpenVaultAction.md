[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerOpenVaultAction

# Class: MakerOpenVaultAction
...
- [constructor](MakerOpenVaultAction.md#constructor)

### Properties

- [args](MakerOpenVaultAction.md#args)
- [contractAddress](MakerOpenVaultAction.md#contractaddress)
- [mappableArgs](MakerOpenVaultAction.md#mappableargs)
- [name](MakerOpenVaultAction.md#name)
- [paramTypes](MakerOpenVaultAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerOpenVaultAction.md#_encodeforcall)
- [\_formatType](MakerOpenVaultAction.md#_formattype)
- [\_getArgumentMapping](MakerOpenVaultAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerOpenVaultAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerOpenVaultAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerOpenVaultAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerOpenVaultAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerOpenVaultAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerOpenVaultAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerOpenVaultAction.md#encodeforrecipe)
- [encodeForStrategy](MakerOpenVaultAction.md#encodeforstrategy)
- [getAccessList](MakerOpenVaultAction.md#getaccesslist)
- [getAssetsToApprove](MakerOpenVaultAction.md#getassetstoapprove)
- [getEthValue](MakerOpenVaultAction.md#getethvalue)
- [getId](MakerOpenVaultAction.md#getid)
...
[src/actions/maker/MakerOpenVaultAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerOpenVaultAction.ts#L15)
