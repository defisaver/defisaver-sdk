...
| `amount` | `string` | amount of base token to be paid back |
| `from` | `string` | address from which funds are paid |
| `onBehalf` | `string` | address for which the funds are paid back |
| `asset` | `string` | address for which the funds are paid back |
...
[src/actions/compoundV3/CompoundV3PaybackAction.ts:23](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3PaybackAction.ts#L23)
...
[src/actions/compoundV3/CompoundV3PaybackAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3PaybackAction.ts#L14)
...
[src/actions/compoundV3/CompoundV3PaybackAction.ts:42](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3PaybackAction.ts#L42)
