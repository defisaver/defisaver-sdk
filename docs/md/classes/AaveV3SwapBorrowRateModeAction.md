[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3SwapBorrowRateModeAction

# Class: AaveV3SwapBorrowRateModeAction
...
- [constructor](AaveV3SwapBorrowRateModeAction.md#constructor)

### Properties

- [args](AaveV3SwapBorrowRateModeAction.md#args)
- [contractAddress](AaveV3SwapBorrowRateModeAction.md#contractaddress)
- [mappableArgs](AaveV3SwapBorrowRateModeAction.md#mappableargs)
- [name](AaveV3SwapBorrowRateModeAction.md#name)
- [paramTypes](AaveV3SwapBorrowRateModeAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveV3SwapBorrowRateModeAction.md#_encodeforcall)
- [\_formatType](AaveV3SwapBorrowRateModeAction.md#_formattype)
- [\_getArgumentMapping](AaveV3SwapBorrowRateModeAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV3SwapBorrowRateModeAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV3SwapBorrowRateModeAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV3SwapBorrowRateModeAction.md#_replacewithplaceholders)
- [addressToBytes20](AaveV3SwapBorrowRateModeAction.md#addresstobytes20)
- [boolToBytes1](AaveV3SwapBorrowRateModeAction.md#booltobytes1)
- [encodeForDsProxyCall](AaveV3SwapBorrowRateModeAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV3SwapBorrowRateModeAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV3SwapBorrowRateModeAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveV3SwapBorrowRateModeAction.md#encodeforrecipe)
- [encodeForStrategy](AaveV3SwapBorrowRateModeAction.md#encodeforstrategy)
- [encodeInputs](AaveV3SwapBorrowRateModeAction.md#encodeinputs)
- [getAccessList](AaveV3SwapBorrowRateModeAction.md#getaccesslist)
- [getAssetsToApprove](AaveV3SwapBorrowRateModeAction.md#getassetstoapprove)
- [getEthValue](AaveV3SwapBorrowRateModeAction.md#getethvalue)
- [getId](AaveV3SwapBorrowRateModeAction.md#getid)
- [numberToBytes1](AaveV3SwapBorrowRateModeAction.md#numbertobytes1)
- [numberToBytes2](AaveV3SwapBorrowRateModeAction.md#numbertobytes2)
- [numberToBytes32](AaveV3SwapBorrowRateModeAction.md#numbertobytes32)

## Constructors

### constructor

• **new AaveV3SwapBorrowRateModeAction**(`useDefaultMarket`, `market`, `rateMode`, `assetId`)
...
| `rateMode` | `string` | {string} rate mode the user is swapping from.[Stable: 1, Variable: 2] |
| `assetId` | `string` | {number} id of the underlying asset in the market |
...
[src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts#L19)
...
[src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts:30](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts#L30)
