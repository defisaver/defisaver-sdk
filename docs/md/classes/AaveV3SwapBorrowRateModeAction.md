...
| `rateMode` | `string` | rate mode the user is swapping from.[Stable: 1, Variable: 2] |
| `assetId` | `string` | id of the underlying asset in the market |
...
[src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts#L19)
...
[src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts:30](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3SwapBorrowRateModeAction.ts#L30)
