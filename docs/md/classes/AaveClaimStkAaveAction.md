[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveClaimStkAaveAction

# Class: AaveClaimStkAaveAction
...
- [constructor](AaveClaimStkAaveAction.md#constructor)

### Properties

- [args](AaveClaimStkAaveAction.md#args)
- [contractAddress](AaveClaimStkAaveAction.md#contractaddress)
- [mappableArgs](AaveClaimStkAaveAction.md#mappableargs)
- [name](AaveClaimStkAaveAction.md#name)
- [paramTypes](AaveClaimStkAaveAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveClaimStkAaveAction.md#_encodeforcall)
- [\_formatType](AaveClaimStkAaveAction.md#_formattype)
- [\_getArgumentMapping](AaveClaimStkAaveAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveClaimStkAaveAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveClaimStkAaveAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveClaimStkAaveAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveClaimStkAaveAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveClaimStkAaveAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveClaimStkAaveAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveClaimStkAaveAction.md#encodeforrecipe)
- [encodeForStrategy](AaveClaimStkAaveAction.md#encodeforstrategy)
- [getAccessList](AaveClaimStkAaveAction.md#getaccesslist)
- [getAssetsToApprove](AaveClaimStkAaveAction.md#getassetstoapprove)
- [getEthValue](AaveClaimStkAaveAction.md#getethvalue)
- [getId](AaveClaimStkAaveAction.md#getid)

## Constructors

### constructor

• **new AaveClaimStkAaveAction**(`assets`, `amount`, `to`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `assets` | `string`[] | List of Asset Addresses |
| `amount` | `string` | Amount to claim |
| `to` | `string` | Address where claimed tokens will end up |
...
[src/actions/aave/AaveClaimStkAaveAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aave/AaveClaimStkAaveAction.ts#L17)
