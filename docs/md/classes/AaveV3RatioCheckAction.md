[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3RatioCheckAction

# Class: AaveV3RatioCheckAction
...
- [constructor](AaveV3RatioCheckAction.md#constructor)

### Properties

- [args](AaveV3RatioCheckAction.md#args)
- [contractAddress](AaveV3RatioCheckAction.md#contractaddress)
- [mappableArgs](AaveV3RatioCheckAction.md#mappableargs)
- [name](AaveV3RatioCheckAction.md#name)
- [paramTypes](AaveV3RatioCheckAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveV3RatioCheckAction.md#_encodeforcall)
- [\_formatType](AaveV3RatioCheckAction.md#_formattype)
- [\_getArgumentMapping](AaveV3RatioCheckAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV3RatioCheckAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV3RatioCheckAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV3RatioCheckAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveV3RatioCheckAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV3RatioCheckAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV3RatioCheckAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveV3RatioCheckAction.md#encodeforrecipe)
- [encodeForStrategy](AaveV3RatioCheckAction.md#encodeforstrategy)
- [getAccessList](AaveV3RatioCheckAction.md#getaccesslist)
- [getAssetsToApprove](AaveV3RatioCheckAction.md#getassetstoapprove)
- [getEthValue](AaveV3RatioCheckAction.md#getethvalue)
- [getId](AaveV3RatioCheckAction.md#getid)

## Constructors

### constructor

• **new AaveV3RatioCheckAction**(`ratioState`, `targetRatio`)
...
[src/actions/checkers/AaveV3RatioCheckAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/checkers/AaveV3RatioCheckAction.ts#L15)
