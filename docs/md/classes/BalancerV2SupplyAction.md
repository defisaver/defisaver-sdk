[@defisaver/sdk](../README.md) / [Exports](../modules.md) / BalancerV2SupplyAction

# Class: BalancerV2SupplyAction
...
- [constructor](BalancerV2SupplyAction.md#constructor)

### Properties

- [args](BalancerV2SupplyAction.md#args)
- [contractAddress](BalancerV2SupplyAction.md#contractaddress)
- [mappableArgs](BalancerV2SupplyAction.md#mappableargs)
- [name](BalancerV2SupplyAction.md#name)
- [paramTypes](BalancerV2SupplyAction.md#paramtypes)

### Methods

- [\_encodeForCall](BalancerV2SupplyAction.md#_encodeforcall)
- [\_formatType](BalancerV2SupplyAction.md#_formattype)
- [\_getArgumentMapping](BalancerV2SupplyAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](BalancerV2SupplyAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](BalancerV2SupplyAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](BalancerV2SupplyAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](BalancerV2SupplyAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](BalancerV2SupplyAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](BalancerV2SupplyAction.md#encodeforl2recipe)
- [encodeForRecipe](BalancerV2SupplyAction.md#encodeforrecipe)
- [encodeForStrategy](BalancerV2SupplyAction.md#encodeforstrategy)
- [getAccessList](BalancerV2SupplyAction.md#getaccesslist)
- [getAssetsToApprove](BalancerV2SupplyAction.md#getassetstoapprove)
- [getEthValue](BalancerV2SupplyAction.md#getethvalue)
- [getId](BalancerV2SupplyAction.md#getid)
...
[src/actions/balancer/BalancerV2SupplyAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/balancer/BalancerV2SupplyAction.ts#L19)
...
▸ **getAssetsToApprove**(): `Promise`<{ `asset`: `string` ; `owner`: `string` ; `specialApproveLabel`: `string`  }[]\>
...
`Promise`<{ `asset`: `string` ; `owner`: `string` ; `specialApproveLabel`: `string`  }[]\>
...
[src/actions/balancer/BalancerV2SupplyAction.ts:44](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/balancer/BalancerV2SupplyAction.ts#L44)
