[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerSupplyAction

# Class: MakerSupplyAction
...
- [constructor](MakerSupplyAction.md#constructor)

### Properties

- [args](MakerSupplyAction.md#args)
- [contractAddress](MakerSupplyAction.md#contractaddress)
- [mappableArgs](MakerSupplyAction.md#mappableargs)
- [name](MakerSupplyAction.md#name)
- [paramTypes](MakerSupplyAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerSupplyAction.md#_encodeforcall)
- [\_formatType](MakerSupplyAction.md#_formattype)
- [\_getArgumentMapping](MakerSupplyAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerSupplyAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerSupplyAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerSupplyAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerSupplyAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerSupplyAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerSupplyAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerSupplyAction.md#encodeforrecipe)
- [encodeForStrategy](MakerSupplyAction.md#encodeforstrategy)
- [getAccessList](MakerSupplyAction.md#getaccesslist)
- [getAssetsToApprove](MakerSupplyAction.md#getassetstoapprove)
- [getEthValue](MakerSupplyAction.md#getethvalue)
- [getId](MakerSupplyAction.md#getid)
...
[src/actions/maker/MakerSupplyAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerSupplyAction.ts#L19)
...
[src/actions/maker/MakerSupplyAction.ts:23](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerSupplyAction.ts#L23)
