[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ReflexerGenerateAction

# Class: ReflexerGenerateAction
...
- [constructor](ReflexerGenerateAction.md#constructor)

### Properties

- [args](ReflexerGenerateAction.md#args)
- [contractAddress](ReflexerGenerateAction.md#contractaddress)
- [mappableArgs](ReflexerGenerateAction.md#mappableargs)
- [name](ReflexerGenerateAction.md#name)
- [paramTypes](ReflexerGenerateAction.md#paramtypes)

### Methods

- [\_encodeForCall](ReflexerGenerateAction.md#_encodeforcall)
- [\_formatType](ReflexerGenerateAction.md#_formattype)
- [\_getArgumentMapping](ReflexerGenerateAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ReflexerGenerateAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ReflexerGenerateAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ReflexerGenerateAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ReflexerGenerateAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ReflexerGenerateAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ReflexerGenerateAction.md#encodeforl2recipe)
- [encodeForRecipe](ReflexerGenerateAction.md#encodeforrecipe)
- [encodeForStrategy](ReflexerGenerateAction.md#encodeforstrategy)
- [getAccessList](ReflexerGenerateAction.md#getaccesslist)
- [getAssetsToApprove](ReflexerGenerateAction.md#getassetstoapprove)
- [getEthValue](ReflexerGenerateAction.md#getethvalue)
- [getId](ReflexerGenerateAction.md#getid)

## Constructors

### constructor

• **new ReflexerGenerateAction**(`vaultId`, `amount`, `to`)
...
| :------ | :------ | :------ |
| `vaultId` | `string` | - |
| `amount` | `string` | {string} Amount of Rai to generate in wei |
| `to` | `string` | {EthAddress} Generated Rai will be sent to this address |
...
[src/actions/reflexer/ReflexerGenerateAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/reflexer/ReflexerGenerateAction.ts#L17)
