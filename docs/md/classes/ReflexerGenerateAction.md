...
| :------ | :------ | :------ |
| `safeId` | `string` |  |
| `amount` | `string` | Amount of Rai to generate in wei |
| `to` | `string` | Generated Rai will be sent to this address |
...
[src/actions/reflexer/ReflexerGenerateAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/reflexer/ReflexerGenerateAction.ts#L17)
