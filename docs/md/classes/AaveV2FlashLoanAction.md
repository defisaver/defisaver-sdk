[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV2FlashLoanAction

# Class: AaveV2FlashLoanAction
...
- [constructor](AaveV2FlashLoanAction.md#constructor)

### Properties

- [args](AaveV2FlashLoanAction.md#args)
- [contractAddress](AaveV2FlashLoanAction.md#contractaddress)
- [mappableArgs](AaveV2FlashLoanAction.md#mappableargs)
- [name](AaveV2FlashLoanAction.md#name)
- [paramTypes](AaveV2FlashLoanAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveV2FlashLoanAction.md#_encodeforcall)
- [\_formatType](AaveV2FlashLoanAction.md#_formattype)
- [\_getArgumentMapping](AaveV2FlashLoanAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV2FlashLoanAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV2FlashLoanAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV2FlashLoanAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveV2FlashLoanAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV2FlashLoanAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV2FlashLoanAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveV2FlashLoanAction.md#encodeforrecipe)
- [encodeForStrategy](AaveV2FlashLoanAction.md#encodeforstrategy)
- [getAccessList](AaveV2FlashLoanAction.md#getaccesslist)
- [getAssetsToApprove](AaveV2FlashLoanAction.md#getassetstoapprove)
- [getEthValue](AaveV2FlashLoanAction.md#getethvalue)
- [getId](AaveV2FlashLoanAction.md#getid)

## Constructors

### constructor

• **new AaveV2FlashLoanAction**(`tokens`, `loanAmounts`, `modes`, `loanPayer`, `flParamGetterAddr?`, `flParamGetterData?`)

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `tokens` | `string`[] | `undefined` | {Array<EthAddress>} |
| `loanAmounts` | `string`[] | `undefined` | {Array<string>} |
| `modes` | `string`[] | `undefined` | {Array<number>} |
| `loanPayer` | `string` | `undefined` | {EthAddress} |
| `flParamGetterAddr` | `string` | `undefined` | {EthAddress} |
| `flParamGetterData` | `bytes` | `[]` | {bytes} |
...
[src/actions/flashloan/AaveV2FlashLoanAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/flashloan/AaveV2FlashLoanAction.ts#L19)
