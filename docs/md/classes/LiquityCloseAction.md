[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityCloseAction

# Class: LiquityCloseAction
...
- [constructor](LiquityCloseAction.md#constructor)

### Properties

- [args](LiquityCloseAction.md#args)
- [contractAddress](LiquityCloseAction.md#contractaddress)
- [mappableArgs](LiquityCloseAction.md#mappableargs)
- [name](LiquityCloseAction.md#name)
- [paramTypes](LiquityCloseAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityCloseAction.md#_encodeforcall)
- [\_formatType](LiquityCloseAction.md#_formattype)
- [\_getArgumentMapping](LiquityCloseAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityCloseAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityCloseAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityCloseAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityCloseAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityCloseAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityCloseAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityCloseAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityCloseAction.md#encodeforstrategy)
- [getAccessList](LiquityCloseAction.md#getaccesslist)
- [getAssetsToApprove](LiquityCloseAction.md#getassetstoapprove)
- [getEthValue](LiquityCloseAction.md#getethvalue)
- [getId](LiquityCloseAction.md#getid)
...
| :------ | :------ | :------ |
| `from` | `string` | Address that will supply the LUSD needed to repay the debt |
| `to` | `string` | Address that will receive the freed collateral |
...
[src/actions/liquity/LiquityCloseAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquityCloseAction.ts#L17)
...
[src/actions/liquity/LiquityCloseAction.ts:31](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquityCloseAction.ts#L31)
