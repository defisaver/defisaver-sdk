[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveSupplyAction

# Class: AaveSupplyAction
...
- [constructor](AaveSupplyAction.md#constructor)

### Properties

- [args](AaveSupplyAction.md#args)
- [contractAddress](AaveSupplyAction.md#contractaddress)
- [mappableArgs](AaveSupplyAction.md#mappableargs)
- [name](AaveSupplyAction.md#name)
- [paramTypes](AaveSupplyAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveSupplyAction.md#_encodeforcall)
- [\_formatType](AaveSupplyAction.md#_formattype)
- [\_getArgumentMapping](AaveSupplyAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveSupplyAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveSupplyAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveSupplyAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveSupplyAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveSupplyAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveSupplyAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveSupplyAction.md#encodeforrecipe)
- [encodeForStrategy](AaveSupplyAction.md#encodeforstrategy)
- [getAccessList](AaveSupplyAction.md#getaccesslist)
- [getAssetsToApprove](AaveSupplyAction.md#getassetstoapprove)
- [getEthValue](AaveSupplyAction.md#getethvalue)
- [getId](AaveSupplyAction.md#getid)
...
| `onBehalf` | `string` | Tokens will be supplied to this address' position (defaults to sender's proxy) |
...
[src/actions/aave/AaveSupplyAction.ts:20](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aave/AaveSupplyAction.ts#L20)
...
[src/actions/aave/AaveSupplyAction.ts:32](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aave/AaveSupplyAction.ts#L32)
