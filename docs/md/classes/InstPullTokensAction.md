[@defisaver/sdk](../README.md) / [Exports](../modules.md) / InstPullTokensAction

# Class: InstPullTokensAction
...
- [constructor](InstPullTokensAction.md#constructor)

### Properties

- [args](InstPullTokensAction.md#args)
- [contractAddress](InstPullTokensAction.md#contractaddress)
- [mappableArgs](InstPullTokensAction.md#mappableargs)
- [name](InstPullTokensAction.md#name)
- [paramTypes](InstPullTokensAction.md#paramtypes)

### Methods

- [\_encodeForCall](InstPullTokensAction.md#_encodeforcall)
- [\_formatType](InstPullTokensAction.md#_formattype)
- [\_getArgumentMapping](InstPullTokensAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](InstPullTokensAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](InstPullTokensAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](InstPullTokensAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](InstPullTokensAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](InstPullTokensAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](InstPullTokensAction.md#encodeforl2recipe)
- [encodeForRecipe](InstPullTokensAction.md#encodeforrecipe)
- [encodeForStrategy](InstPullTokensAction.md#encodeforstrategy)
- [getAccessList](InstPullTokensAction.md#getaccesslist)
- [getAssetsToApprove](InstPullTokensAction.md#getassetstoapprove)
- [getEthValue](InstPullTokensAction.md#getethvalue)
- [getId](InstPullTokensAction.md#getid)

## Constructors

### constructor

• **new InstPullTokensAction**(`dsaAddress`, `tokens`, `amounts`, `to`)
...
[src/actions/insta/InstPullTokensAction.ts:11](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/insta/InstPullTokensAction.ts#L11)
...
▸ **getAssetsToApprove**(): `Promise`<{ `dsaAddress`: `any` ; `specialApproveLabel`: `string` = 'Instadapp' }[]\>
...
`Promise`<{ `dsaAddress`: `any` ; `specialApproveLabel`: `string` = 'Instadapp' }[]\>
...
[src/actions/insta/InstPullTokensAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/insta/InstPullTokensAction.ts#L22)
