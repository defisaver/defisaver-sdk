[@defisaver/sdk](../README.md) / [Exports](../modules.md) / YearnWithdrawAction
...
| :------ | :------ | :------ |
| `tokenAddr` | `string` | {EthAddress} yToken address |
| `amount` | `string` | {string} amount of yTokens to burn |
| `from` | `string` | {EthAddress} yTokens will be taken from this address |
| `to` | `string` | {ETHAddress} underlying tokens will be sent to this address |
...
[src/actions/yearn/YearnWithdrawAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/yearn/YearnWithdrawAction.ts#L19)
...
[src/actions/yearn/YearnWithdrawAction.ts:29](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/yearn/YearnWithdrawAction.ts#L29)
