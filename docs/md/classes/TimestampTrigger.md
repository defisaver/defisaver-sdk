[@defisaver/sdk](../README.md) / [Exports](../modules.md) / TimestampTrigger
...
- [constructor](TimestampTrigger.md#constructor)

### Properties

- [args](TimestampTrigger.md#args)
- [contractAddress](TimestampTrigger.md#contractaddress)
- [mappableArgs](TimestampTrigger.md#mappableargs)
- [name](TimestampTrigger.md#name)
- [paramTypes](TimestampTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](TimestampTrigger.md#_encodeforcall)
- [\_formatType](TimestampTrigger.md#_formattype)
- [\_getArgumentMapping](TimestampTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](TimestampTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](TimestampTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](TimestampTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](TimestampTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](TimestampTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](TimestampTrigger.md#encodeforl2recipe)
- [encodeForRecipe](TimestampTrigger.md#encodeforrecipe)
- [encodeForStrategy](TimestampTrigger.md#encodeforstrategy)
- [getAccessList](TimestampTrigger.md#getaccesslist)
- [getAssetsToApprove](TimestampTrigger.md#getassetstoapprove)
- [getEthValue](TimestampTrigger.md#getethvalue)
- [getId](TimestampTrigger.md#getid)

## Constructors

### constructor

• **new TimestampTrigger**(`nextTimestamp`)
...
[src/triggers/TimestampTrigger.ts:12](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/TimestampTrigger.ts#L12)
