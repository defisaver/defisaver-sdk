[@defisaver/sdk](../README.md) / [Exports](../modules.md) / GUniWithdraw
...
- [constructor](GUniWithdraw.md#constructor)

### Properties

- [args](GUniWithdraw.md#args)
- [contractAddress](GUniWithdraw.md#contractaddress)
- [mappableArgs](GUniWithdraw.md#mappableargs)
- [name](GUniWithdraw.md#name)
- [paramTypes](GUniWithdraw.md#paramtypes)

### Methods

- [\_encodeForCall](GUniWithdraw.md#_encodeforcall)
- [\_formatType](GUniWithdraw.md#_formattype)
- [\_getArgumentMapping](GUniWithdraw.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](GUniWithdraw.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](GUniWithdraw.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](GUniWithdraw.md#_replacewithplaceholders)
- [encodeForDsProxyCall](GUniWithdraw.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](GUniWithdraw.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](GUniWithdraw.md#encodeforl2recipe)
- [encodeForRecipe](GUniWithdraw.md#encodeforrecipe)
- [encodeForStrategy](GUniWithdraw.md#encodeforstrategy)
- [getAccessList](GUniWithdraw.md#getaccesslist)
- [getAssetsToApprove](GUniWithdraw.md#getassetstoapprove)
- [getEthValue](GUniWithdraw.md#getethvalue)
- [getId](GUniWithdraw.md#getid)

## Constructors

### constructor

• **new GUniWithdraw**(`pool`, `burnAmount`, `amount0Min`, `amount1Min`, `to`, `from`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `pool` | `string` | address of G-UNI pool to remove liquidity from |
| `burnAmount` | `string` | The number of G-UNI tokens to burn |
| `amount0Min` | `string` | Minimum amount of token0 received after burn (slippage protection) |
| `amount1Min` | `string` | Minimum amount of token1 received after burn (slippage protection) |
| `to` | `string` | The account to receive the underlying amounts of token0 and token1 |
| `from` | `string` | Account from which to pull G-Uni LP tokens |
...
[src/actions/guni/GUniWithdraw.ts:20](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/guni/GUniWithdraw.ts#L20)
...
[src/actions/guni/GUniWithdraw.ts:33](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/guni/GUniWithdraw.ts#L33)
