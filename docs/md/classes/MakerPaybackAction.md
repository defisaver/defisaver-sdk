[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerPaybackAction
...
- [constructor](MakerPaybackAction.md#constructor)

### Properties

- [args](MakerPaybackAction.md#args)
- [contractAddress](MakerPaybackAction.md#contractaddress)
- [mappableArgs](MakerPaybackAction.md#mappableargs)
- [name](MakerPaybackAction.md#name)
- [paramTypes](MakerPaybackAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerPaybackAction.md#_encodeforcall)
- [\_formatType](MakerPaybackAction.md#_formattype)
- [\_getArgumentMapping](MakerPaybackAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerPaybackAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerPaybackAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerPaybackAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerPaybackAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerPaybackAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerPaybackAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerPaybackAction.md#encodeforrecipe)
- [encodeForStrategy](MakerPaybackAction.md#encodeforstrategy)
- [getAccessList](MakerPaybackAction.md#getaccesslist)
- [getAssetsToApprove](MakerPaybackAction.md#getassetstoapprove)
- [getEthValue](MakerPaybackAction.md#getethvalue)
- [getId](MakerPaybackAction.md#getid)
...
| `from` | `string` | {EthAddress} DAI will be sent from this address |
| `mcdManager` | `string` | {EthAddress} |
...
[src/actions/maker/MakerPaybackAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerPaybackAction.ts#L18)
...
[src/actions/maker/MakerPaybackAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerPaybackAction.ts#L22)
