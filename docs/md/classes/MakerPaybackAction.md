...
| `vaultId` | `string` |  |
| `amount` | `string` |  |
| `from` | `string` | DAI will be sent from this address |
| `mcdManager` | `string` |  |
...
[src/actions/maker/MakerPaybackAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/maker/MakerPaybackAction.ts#L18)
...
[src/actions/maker/MakerPaybackAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/maker/MakerPaybackAction.ts#L22)
