[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquitySupplyAction

# Class: LiquitySupplyAction
...
- [constructor](LiquitySupplyAction.md#constructor)

### Properties

- [args](LiquitySupplyAction.md#args)
- [contractAddress](LiquitySupplyAction.md#contractaddress)
- [mappableArgs](LiquitySupplyAction.md#mappableargs)
- [name](LiquitySupplyAction.md#name)
- [paramTypes](LiquitySupplyAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquitySupplyAction.md#_encodeforcall)
- [\_formatType](LiquitySupplyAction.md#_formattype)
- [\_getArgumentMapping](LiquitySupplyAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquitySupplyAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquitySupplyAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquitySupplyAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquitySupplyAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquitySupplyAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquitySupplyAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquitySupplyAction.md#encodeforrecipe)
- [encodeForStrategy](LiquitySupplyAction.md#encodeforstrategy)
- [getAccessList](LiquitySupplyAction.md#getaccesslist)
- [getAssetsToApprove](LiquitySupplyAction.md#getassetstoapprove)
- [getEthValue](LiquitySupplyAction.md#getethvalue)
- [getId](LiquitySupplyAction.md#getid)

## Constructors

### constructor

• **new LiquitySupplyAction**(`collAmount`, `from`, `upperHint`, `lowerHint`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `collAmount` | `string` | Amount of WETH tokens to supply |
...
[src/actions/liquity/LiquitySupplyAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquitySupplyAction.ts#L17)
...
[src/actions/liquity/LiquitySupplyAction.ts:30](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquitySupplyAction.ts#L30)
