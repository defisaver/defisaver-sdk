[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundV3ClaimAction

# Class: CompoundV3ClaimAction
...
- [constructor](CompoundV3ClaimAction.md#constructor)

### Properties

- [args](CompoundV3ClaimAction.md#args)
- [contractAddress](CompoundV3ClaimAction.md#contractaddress)
- [mappableArgs](CompoundV3ClaimAction.md#mappableargs)
- [name](CompoundV3ClaimAction.md#name)
- [paramTypes](CompoundV3ClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundV3ClaimAction.md#_encodeforcall)
- [\_formatType](CompoundV3ClaimAction.md#_formattype)
- [\_getArgumentMapping](CompoundV3ClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundV3ClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundV3ClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundV3ClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundV3ClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundV3ClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundV3ClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundV3ClaimAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundV3ClaimAction.md#encodeforstrategy)
- [getAccessList](CompoundV3ClaimAction.md#getaccesslist)
- [getAssetsToApprove](CompoundV3ClaimAction.md#getassetstoapprove)
- [getEthValue](CompoundV3ClaimAction.md#getethvalue)
- [getId](CompoundV3ClaimAction.md#getid)

## Constructors

### constructor

• **new CompoundV3ClaimAction**(`market`, `onBehalfOf`, `to`, `shouldAccrue`)
...
| `onBehalfOf` | `string` | {EthAddress} The owner to claim for |
| `to` | `string` | {EthAddress} The address to receive the rewards |
| `shouldAccrue` | `boolean` | {bool} If true, the protocol will account for the rewards owed to the account as of the current block before transferring |
...
[src/actions/compoundV3/CompoundV3ClaimAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compoundV3/CompoundV3ClaimAction.ts#L18)
