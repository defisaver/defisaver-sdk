...
| `onBehalfOf` | `string` | The owner to claim for |
| `to` | `string` | The address to receive the rewards |
| `shouldAccrue` | `boolean` | If true, the protocol will account for the rewards owed to the account as of the current block before transferring |
...
[src/actions/compoundV3/CompoundV3ClaimAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3ClaimAction.ts#L18)
