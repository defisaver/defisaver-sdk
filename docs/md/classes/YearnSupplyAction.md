[@defisaver/sdk](../README.md) / [Exports](../modules.md) / YearnSupplyAction
...
| :------ | :------ | :------ |
| `tokenAddr` | `string` | {EthAddress} token address |
| `amount` | `string` | {string} amount of tokens to supply |
| `from` | `string` | {EthAddress} Tokens will be supplied from this address |
| `to` | `string` | {ETHAddress} yTokens will be sent to this address |
...
[src/actions/yearn/YearnSupplyAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/yearn/YearnSupplyAction.ts#L19)
...
[src/actions/yearn/YearnSupplyAction.ts:29](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/yearn/YearnSupplyAction.ts#L29)
