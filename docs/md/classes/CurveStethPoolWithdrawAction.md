[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveStethPoolWithdrawAction

# Class: CurveStethPoolWithdrawAction
...
- [constructor](CurveStethPoolWithdrawAction.md#constructor)

### Properties

- [args](CurveStethPoolWithdrawAction.md#args)
- [contractAddress](CurveStethPoolWithdrawAction.md#contractaddress)
- [mappableArgs](CurveStethPoolWithdrawAction.md#mappableargs)
- [name](CurveStethPoolWithdrawAction.md#name)
- [paramTypes](CurveStethPoolWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](CurveStethPoolWithdrawAction.md#_encodeforcall)
- [\_formatType](CurveStethPoolWithdrawAction.md#_formattype)
- [\_getArgumentMapping](CurveStethPoolWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveStethPoolWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveStethPoolWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveStethPoolWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveStethPoolWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveStethPoolWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveStethPoolWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveStethPoolWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](CurveStethPoolWithdrawAction.md#encodeforstrategy)
- [getAccessList](CurveStethPoolWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](CurveStethPoolWithdrawAction.md#getassetstoapprove)
- [getEthValue](CurveStethPoolWithdrawAction.md#getethvalue)
- [getId](CurveStethPoolWithdrawAction.md#getid)
...
[src/actions/curve/CurveStethPoolWithdrawAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/curve/CurveStethPoolWithdrawAction.ts#L19)
