[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveGaugeWithdrawAction

# Class: CurveGaugeWithdrawAction
...
- [constructor](CurveGaugeWithdrawAction.md#constructor)

### Properties

- [args](CurveGaugeWithdrawAction.md#args)
- [contractAddress](CurveGaugeWithdrawAction.md#contractaddress)
- [mappableArgs](CurveGaugeWithdrawAction.md#mappableargs)
- [name](CurveGaugeWithdrawAction.md#name)
- [paramTypes](CurveGaugeWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](CurveGaugeWithdrawAction.md#_encodeforcall)
- [\_formatType](CurveGaugeWithdrawAction.md#_formattype)
- [\_getArgumentMapping](CurveGaugeWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveGaugeWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveGaugeWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveGaugeWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveGaugeWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveGaugeWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveGaugeWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveGaugeWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](CurveGaugeWithdrawAction.md#encodeforstrategy)
- [getAccessList](CurveGaugeWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](CurveGaugeWithdrawAction.md#getassetstoapprove)
- [getEthValue](CurveGaugeWithdrawAction.md#getethvalue)
- [getId](CurveGaugeWithdrawAction.md#getid)
...
[src/actions/curve/CurveGaugeWithdrawAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveGaugeWithdrawAction.ts#L17)
