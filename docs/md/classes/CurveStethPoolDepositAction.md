[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveStethPoolDepositAction

# Class: CurveStethPoolDepositAction
...
- [constructor](CurveStethPoolDepositAction.md#constructor)

### Properties

- [args](CurveStethPoolDepositAction.md#args)
- [contractAddress](CurveStethPoolDepositAction.md#contractaddress)
- [mappableArgs](CurveStethPoolDepositAction.md#mappableargs)
- [name](CurveStethPoolDepositAction.md#name)
- [paramTypes](CurveStethPoolDepositAction.md#paramtypes)

### Methods

- [\_encodeForCall](CurveStethPoolDepositAction.md#_encodeforcall)
- [\_formatType](CurveStethPoolDepositAction.md#_formattype)
- [\_getArgumentMapping](CurveStethPoolDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveStethPoolDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveStethPoolDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveStethPoolDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveStethPoolDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveStethPoolDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveStethPoolDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveStethPoolDepositAction.md#encodeforrecipe)
- [encodeForStrategy](CurveStethPoolDepositAction.md#encodeforstrategy)
- [getAccessList](CurveStethPoolDepositAction.md#getaccesslist)
- [getAssetsToApprove](CurveStethPoolDepositAction.md#getassetstoapprove)
- [getEthValue](CurveStethPoolDepositAction.md#getethvalue)
- [getId](CurveStethPoolDepositAction.md#getid)
...
[src/actions/curve/CurveStethPoolDepositAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/curve/CurveStethPoolDepositAction.ts#L18)
