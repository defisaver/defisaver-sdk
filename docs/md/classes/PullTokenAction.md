...
| `amount` | `string` | Transfer amount (-1 for whole sender balance) |
...
[src/actions/basic/PullTokenAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/PullTokenAction.ts#L18)
...
[src/actions/basic/PullTokenAction.ts:32](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/PullTokenAction.ts#L32)
