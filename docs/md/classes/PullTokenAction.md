[@defisaver/sdk](../README.md) / [Exports](../modules.md) / PullTokenAction
...
- [constructor](PullTokenAction.md#constructor)

### Properties

- [args](PullTokenAction.md#args)
- [contractAddress](PullTokenAction.md#contractaddress)
- [mappableArgs](PullTokenAction.md#mappableargs)
- [name](PullTokenAction.md#name)
- [paramTypes](PullTokenAction.md#paramtypes)

### Methods

- [\_encodeForCall](PullTokenAction.md#_encodeforcall)
- [\_formatType](PullTokenAction.md#_formattype)
- [\_getArgumentMapping](PullTokenAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](PullTokenAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](PullTokenAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](PullTokenAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](PullTokenAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](PullTokenAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](PullTokenAction.md#encodeforl2recipe)
- [encodeForRecipe](PullTokenAction.md#encodeforrecipe)
- [encodeForStrategy](PullTokenAction.md#encodeforstrategy)
- [getAccessList](PullTokenAction.md#getaccesslist)
- [getAssetsToApprove](PullTokenAction.md#getassetstoapprove)
- [getEthValue](PullTokenAction.md#getethvalue)
- [getId](PullTokenAction.md#getid)
...
| `from` | `string` | {string} Transfer sender |
| `amount` | `string` | {string} Transfer amount (-1 for whole sender balance) |
...
[src/actions/basic/PullTokenAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/PullTokenAction.ts#L18)
...
[src/actions/basic/PullTokenAction.ts:32](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/PullTokenAction.ts#L32)
