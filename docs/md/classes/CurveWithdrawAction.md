[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveWithdrawAction

# Class: CurveWithdrawAction
...
- [constructor](CurveWithdrawAction.md#constructor)

### Properties

- [args](CurveWithdrawAction.md#args)
- [contractAddress](CurveWithdrawAction.md#contractaddress)
- [lpToken](CurveWithdrawAction.md#lptoken)
- [mappableArgs](CurveWithdrawAction.md#mappableargs)
- [name](CurveWithdrawAction.md#name)
- [paramTypes](CurveWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](CurveWithdrawAction.md#_encodeforcall)
- [\_formatType](CurveWithdrawAction.md#_formattype)
- [\_getArgumentMapping](CurveWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](CurveWithdrawAction.md#encodeforstrategy)
- [getAccessList](CurveWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](CurveWithdrawAction.md#getassetstoapprove)
- [getEthValue](CurveWithdrawAction.md#getethvalue)
- [getId](CurveWithdrawAction.md#getid)

## Constructors

### constructor

• **new CurveWithdrawAction**(`sender`, `receiver`, `poolAddr`, `burnAmount`, `useUnderlying`, `withdrawExact`, `minAmounts?`)
...
| `useUnderlying` | `boolean` | `undefined` |
| `withdrawExact` | `boolean` | `undefined` |
| `minAmounts` | `string`[] | `[]` |
...
[src/actions/curve/CurveWithdrawAction.ts:25](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveWithdrawAction.ts#L25)
...
[src/actions/curve/CurveWithdrawAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveWithdrawAction.ts#L14)
...
[src/actions/curve/CurveWithdrawAction.ts:79](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveWithdrawAction.ts#L79)
