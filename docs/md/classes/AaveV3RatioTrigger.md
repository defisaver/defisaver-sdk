[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3RatioTrigger

# Class: AaveV3RatioTrigger
...
- [constructor](AaveV3RatioTrigger.md#constructor)

### Properties

- [args](AaveV3RatioTrigger.md#args)
- [contractAddress](AaveV3RatioTrigger.md#contractaddress)
- [mappableArgs](AaveV3RatioTrigger.md#mappableargs)
- [name](AaveV3RatioTrigger.md#name)
- [paramTypes](AaveV3RatioTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](AaveV3RatioTrigger.md#_encodeforcall)
- [\_formatType](AaveV3RatioTrigger.md#_formattype)
- [\_getArgumentMapping](AaveV3RatioTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV3RatioTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV3RatioTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV3RatioTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveV3RatioTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV3RatioTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV3RatioTrigger.md#encodeforl2recipe)
- [encodeForRecipe](AaveV3RatioTrigger.md#encodeforrecipe)
- [encodeForStrategy](AaveV3RatioTrigger.md#encodeforstrategy)
- [getAccessList](AaveV3RatioTrigger.md#getaccesslist)
- [getAssetsToApprove](AaveV3RatioTrigger.md#getassetstoapprove)
- [getEthValue](AaveV3RatioTrigger.md#getethvalue)
- [getId](AaveV3RatioTrigger.md#getid)

## Constructors

### constructor

• **new AaveV3RatioTrigger**(`user`, `market`, `ratio`, `state`)
...
[src/triggers/AaveV3RatioTrigger.ts:12](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/triggers/AaveV3RatioTrigger.ts#L12)
