[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ConvexClaimAction

# Class: ConvexClaimAction
...
- [constructor](ConvexClaimAction.md#constructor)

### Properties

- [args](ConvexClaimAction.md#args)
- [contractAddress](ConvexClaimAction.md#contractaddress)
- [curveLp](ConvexClaimAction.md#curvelp)
- [mappableArgs](ConvexClaimAction.md#mappableargs)
- [name](ConvexClaimAction.md#name)
- [paramTypes](ConvexClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](ConvexClaimAction.md#_encodeforcall)
- [\_formatType](ConvexClaimAction.md#_formattype)
- [\_getArgumentMapping](ConvexClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ConvexClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ConvexClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ConvexClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ConvexClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ConvexClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ConvexClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](ConvexClaimAction.md#encodeforrecipe)
- [encodeForStrategy](ConvexClaimAction.md#encodeforstrategy)
- [getAccessList](ConvexClaimAction.md#getaccesslist)
- [getAssetsToApprove](ConvexClaimAction.md#getassetstoapprove)
- [getEthValue](ConvexClaimAction.md#getethvalue)
- [getId](ConvexClaimAction.md#getid)

## Constructors

### constructor

• **new ConvexClaimAction**(`from`, `to`, `curveLp`)
...
[src/actions/convex/ConvexClaimAction.ts:21](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/convex/ConvexClaimAction.ts#L21)
...
[src/actions/convex/ConvexClaimAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/convex/ConvexClaimAction.ts#L14)
...
[src/actions/convex/ConvexClaimAction.ts:53](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/convex/ConvexClaimAction.ts#L53)
