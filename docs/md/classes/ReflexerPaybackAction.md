[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ReflexerPaybackAction
...
| :------ | :------ | :------ |
| `safeId` | `string` |  |
| `amount` | `string` | Amount of RAI to be payed back in wei |
| `from` | `string` | RAI will be sent from this address |
...
[src/actions/reflexer/ReflexerPaybackAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/reflexer/ReflexerPaybackAction.ts#L17)
...
[src/actions/reflexer/ReflexerPaybackAction.ts:21](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/reflexer/ReflexerPaybackAction.ts#L21)
