[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3BorrowAction
...
| `amount` | `string` | Amount of tokens to be borrowed |
| `to` | `string` | The address we are sending the borrowed tokens to |
| `rateMode` | `string` | Type of borrow debt [Stable: 1, Variable: 2] |
| `assetId` | `string` | The id of the token to be borrowed |
| `useOnBehalf` | `boolean` | use on behalf or default to proxy |
| `onBehalf` | `string` | On whose behalf we borrow the tokens, defaults to proxy |
...
[src/actions/aaveV3/AaveV3BorrowAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3BorrowAction.ts#L22)
...
[src/actions/aaveV3/AaveV3BorrowAction.ts:41](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/aaveV3/AaveV3BorrowAction.ts#L41)
