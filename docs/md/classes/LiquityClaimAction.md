[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityClaimAction

# Class: LiquityClaimAction
...
- [constructor](LiquityClaimAction.md#constructor)

### Properties

- [args](LiquityClaimAction.md#args)
- [contractAddress](LiquityClaimAction.md#contractaddress)
- [mappableArgs](LiquityClaimAction.md#mappableargs)
- [name](LiquityClaimAction.md#name)
- [paramTypes](LiquityClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityClaimAction.md#_encodeforcall)
- [\_formatType](LiquityClaimAction.md#_formattype)
- [\_getArgumentMapping](LiquityClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityClaimAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityClaimAction.md#encodeforstrategy)
- [getAccessList](LiquityClaimAction.md#getaccesslist)
- [getAssetsToApprove](LiquityClaimAction.md#getassetstoapprove)
- [getEthValue](LiquityClaimAction.md#getethvalue)
- [getId](LiquityClaimAction.md#getid)
...
| :------ | :------ | :------ |
| `to` | `string` | Address that will receive the collateral |
...
[src/actions/liquity/LiquityClaimAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquityClaimAction.ts#L15)
