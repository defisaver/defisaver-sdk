[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundWithdrawAction

# Class: CompoundWithdrawAction
...
- [constructor](CompoundWithdrawAction.md#constructor)

### Properties

- [args](CompoundWithdrawAction.md#args)
- [contractAddress](CompoundWithdrawAction.md#contractaddress)
- [mappableArgs](CompoundWithdrawAction.md#mappableargs)
- [name](CompoundWithdrawAction.md#name)
- [paramTypes](CompoundWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundWithdrawAction.md#_encodeforcall)
- [\_formatType](CompoundWithdrawAction.md#_formattype)
- [\_getArgumentMapping](CompoundWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundWithdrawAction.md#encodeforstrategy)
- [getAccessList](CompoundWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](CompoundWithdrawAction.md#getassetstoapprove)
- [getEthValue](CompoundWithdrawAction.md#getethvalue)
- [getId](CompoundWithdrawAction.md#getid)
...
[src/actions/compound/CompoundWithdrawAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundWithdrawAction.ts#L17)
