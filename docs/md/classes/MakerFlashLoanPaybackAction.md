[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerFlashLoanPaybackAction

# Class: MakerFlashLoanPaybackAction
...
- [constructor](MakerFlashLoanPaybackAction.md#constructor)

### Properties

- [args](MakerFlashLoanPaybackAction.md#args)
- [contractAddress](MakerFlashLoanPaybackAction.md#contractaddress)
- [mappableArgs](MakerFlashLoanPaybackAction.md#mappableargs)
- [name](MakerFlashLoanPaybackAction.md#name)
- [paramTypes](MakerFlashLoanPaybackAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerFlashLoanPaybackAction.md#_encodeforcall)
- [\_formatType](MakerFlashLoanPaybackAction.md#_formattype)
- [\_getArgumentMapping](MakerFlashLoanPaybackAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerFlashLoanPaybackAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerFlashLoanPaybackAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerFlashLoanPaybackAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerFlashLoanPaybackAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerFlashLoanPaybackAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerFlashLoanPaybackAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerFlashLoanPaybackAction.md#encodeforrecipe)
- [encodeForStrategy](MakerFlashLoanPaybackAction.md#encodeforstrategy)
- [getAccessList](MakerFlashLoanPaybackAction.md#getaccesslist)
- [getAssetsToApprove](MakerFlashLoanPaybackAction.md#getassetstoapprove)
- [getEthValue](MakerFlashLoanPaybackAction.md#getethvalue)
- [getId](MakerFlashLoanPaybackAction.md#getid)

## Constructors

### constructor

• **new MakerFlashLoanPaybackAction**(`loanAmount`, `tokenAddr`)
...
[src/actions/flashloan/MakerFlashLoanPaybackAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/flashloan/MakerFlashLoanPaybackAction.ts#L14)
