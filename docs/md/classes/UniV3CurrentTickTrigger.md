[@defisaver/sdk](../README.md) / [Exports](../modules.md) / UniV3CurrentTickTrigger

# Class: UniV3CurrentTickTrigger
...
- [constructor](UniV3CurrentTickTrigger.md#constructor)

### Properties

- [args](UniV3CurrentTickTrigger.md#args)
- [contractAddress](UniV3CurrentTickTrigger.md#contractaddress)
- [mappableArgs](UniV3CurrentTickTrigger.md#mappableargs)
- [name](UniV3CurrentTickTrigger.md#name)
- [paramTypes](UniV3CurrentTickTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](UniV3CurrentTickTrigger.md#_encodeforcall)
- [\_formatType](UniV3CurrentTickTrigger.md#_formattype)
- [\_getArgumentMapping](UniV3CurrentTickTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](UniV3CurrentTickTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](UniV3CurrentTickTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](UniV3CurrentTickTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](UniV3CurrentTickTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](UniV3CurrentTickTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](UniV3CurrentTickTrigger.md#encodeforl2recipe)
- [encodeForRecipe](UniV3CurrentTickTrigger.md#encodeforrecipe)
- [encodeForStrategy](UniV3CurrentTickTrigger.md#encodeforstrategy)
- [getAccessList](UniV3CurrentTickTrigger.md#getaccesslist)
- [getAssetsToApprove](UniV3CurrentTickTrigger.md#getassetstoapprove)
- [getEthValue](UniV3CurrentTickTrigger.md#getethvalue)
- [getId](UniV3CurrentTickTrigger.md#getid)

## Constructors

### constructor

• **new UniV3CurrentTickTrigger**(`tokenId`, `state`)
...
[src/triggers/UniV3CurrentTickTrigger.ts:11](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/UniV3CurrentTickTrigger.ts#L11)
