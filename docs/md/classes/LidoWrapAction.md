...
| :------ | :------ | :------ |
| `amount` | `string` | amount to pull and stake |
| `from` | `string` | tokens will be taken from this address |
| `to` | `string` | WStEth will be sent to this address |
| `useEth` | `boolean` | true for using WETH, false for using stEth |
...
[src/actions/lido/LidoWrapAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/lido/LidoWrapAction.ts#L19)
...
[src/actions/lido/LidoWrapAction.ts:29](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/lido/LidoWrapAction.ts#L29)
