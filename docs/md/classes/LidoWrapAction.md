[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LidoWrapAction

# Class: LidoWrapAction
...
- [constructor](LidoWrapAction.md#constructor)

### Properties

- [args](LidoWrapAction.md#args)
- [contractAddress](LidoWrapAction.md#contractaddress)
- [mappableArgs](LidoWrapAction.md#mappableargs)
- [name](LidoWrapAction.md#name)
- [paramTypes](LidoWrapAction.md#paramtypes)

### Methods

- [\_encodeForCall](LidoWrapAction.md#_encodeforcall)
- [\_formatType](LidoWrapAction.md#_formattype)
- [\_getArgumentMapping](LidoWrapAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LidoWrapAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LidoWrapAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LidoWrapAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LidoWrapAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LidoWrapAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LidoWrapAction.md#encodeforl2recipe)
- [encodeForRecipe](LidoWrapAction.md#encodeforrecipe)
- [encodeForStrategy](LidoWrapAction.md#encodeforstrategy)
- [getAccessList](LidoWrapAction.md#getaccesslist)
- [getAssetsToApprove](LidoWrapAction.md#getassetstoapprove)
- [getEthValue](LidoWrapAction.md#getethvalue)
- [getId](LidoWrapAction.md#getid)
...
| :------ | :------ | :------ |
| `amount` | `string` | {string} amount to pull and stake |
| `from` | `string` | {EthAddress} tokens will be taken from this address |
| `to` | `string` | {EthAddress} WStEth will be sent to this address |
| `useEth` | `boolean` | {boolean} true for using WETH, false for using stEth |
...
[src/actions/lido/LidoWrapAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/lido/LidoWrapAction.ts#L19)
...
[src/actions/lido/LidoWrapAction.ts:29](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/lido/LidoWrapAction.ts#L29)
