[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ChangeProxyOwnerAction

# Class: ChangeProxyOwnerAction
...
- [constructor](ChangeProxyOwnerAction.md#constructor)

### Properties

- [args](ChangeProxyOwnerAction.md#args)
- [contractAddress](ChangeProxyOwnerAction.md#contractaddress)
- [mappableArgs](ChangeProxyOwnerAction.md#mappableargs)
- [name](ChangeProxyOwnerAction.md#name)
- [paramTypes](ChangeProxyOwnerAction.md#paramtypes)

### Methods

- [\_encodeForCall](ChangeProxyOwnerAction.md#_encodeforcall)
- [\_formatType](ChangeProxyOwnerAction.md#_formattype)
- [\_getArgumentMapping](ChangeProxyOwnerAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ChangeProxyOwnerAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ChangeProxyOwnerAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ChangeProxyOwnerAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ChangeProxyOwnerAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ChangeProxyOwnerAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ChangeProxyOwnerAction.md#encodeforl2recipe)
- [encodeForRecipe](ChangeProxyOwnerAction.md#encodeforrecipe)
- [encodeForStrategy](ChangeProxyOwnerAction.md#encodeforstrategy)
- [getAccessList](ChangeProxyOwnerAction.md#getaccesslist)
- [getAssetsToApprove](ChangeProxyOwnerAction.md#getassetstoapprove)
- [getEthValue](ChangeProxyOwnerAction.md#getethvalue)
- [getId](ChangeProxyOwnerAction.md#getid)
...
[src/actions/basic/ChangeProxyOwnerAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/ChangeProxyOwnerAction.ts#L14)
