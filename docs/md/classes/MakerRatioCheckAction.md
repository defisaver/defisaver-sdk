[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerRatioCheckAction
...
| `startRatioIndex` | `string` | Index in returnValues where ratio before actions is stored |
...
[src/actions/checkers/MakerRatioCheckAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/checkers/MakerRatioCheckAction.ts#L18)
