...
| `vaultId` | `string` |  |
| `joinAddr` | `string` |  |
| `to` | `string` | Tokens will be sent to this address |
...
[src/actions/maker/MakerClaimAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/maker/MakerClaimAction.ts#L17)
