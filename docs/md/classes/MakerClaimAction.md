[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerClaimAction

# Class: MakerClaimAction
...
- [constructor](MakerClaimAction.md#constructor)

### Properties

- [args](MakerClaimAction.md#args)
- [contractAddress](MakerClaimAction.md#contractaddress)
- [mappableArgs](MakerClaimAction.md#mappableargs)
- [name](MakerClaimAction.md#name)
- [paramTypes](MakerClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerClaimAction.md#_encodeforcall)
- [\_formatType](MakerClaimAction.md#_formattype)
- [\_getArgumentMapping](MakerClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerClaimAction.md#encodeforrecipe)
- [encodeForStrategy](MakerClaimAction.md#encodeforstrategy)
- [getAccessList](MakerClaimAction.md#getaccesslist)
- [getAssetsToApprove](MakerClaimAction.md#getassetstoapprove)
- [getEthValue](MakerClaimAction.md#getethvalue)
- [getId](MakerClaimAction.md#getid)
...
| `to` | `string` | {EthAddress} Tokens will be sent to this address |
...
[src/actions/maker/MakerClaimAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerClaimAction.ts#L17)
