[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CBChickenInAction

# Class: CBChickenInAction
...
- [constructor](CBChickenInAction.md#constructor)

### Properties

- [args](CBChickenInAction.md#args)
- [contractAddress](CBChickenInAction.md#contractaddress)
- [mappableArgs](CBChickenInAction.md#mappableargs)
- [name](CBChickenInAction.md#name)
- [paramTypes](CBChickenInAction.md#paramtypes)

### Methods

- [\_encodeForCall](CBChickenInAction.md#_encodeforcall)
- [\_formatType](CBChickenInAction.md#_formattype)
- [\_getArgumentMapping](CBChickenInAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CBChickenInAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CBChickenInAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CBChickenInAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CBChickenInAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CBChickenInAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CBChickenInAction.md#encodeforl2recipe)
- [encodeForRecipe](CBChickenInAction.md#encodeforrecipe)
- [encodeForStrategy](CBChickenInAction.md#encodeforstrategy)
- [getAccessList](CBChickenInAction.md#getaccesslist)
- [getAssetsToApprove](CBChickenInAction.md#getassetstoapprove)
- [getEthValue](CBChickenInAction.md#getethvalue)
- [getId](CBChickenInAction.md#getid)

## Constructors

### constructor

• **new CBChickenInAction**(`bondId`, `to`)
...
[src/actions/chickenBonds/CBChickenInAction.ts:16](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/chickenBonds/CBChickenInAction.ts#L16)
