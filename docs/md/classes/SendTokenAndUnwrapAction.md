[@defisaver/sdk](../README.md) / [Exports](../modules.md) / SendTokenAndUnwrapAction

# Class: SendTokenAndUnwrapAction
...
- [constructor](SendTokenAndUnwrapAction.md#constructor)

### Properties

- [args](SendTokenAndUnwrapAction.md#args)
- [contractAddress](SendTokenAndUnwrapAction.md#contractaddress)
- [mappableArgs](SendTokenAndUnwrapAction.md#mappableargs)
- [name](SendTokenAndUnwrapAction.md#name)
- [paramTypes](SendTokenAndUnwrapAction.md#paramtypes)

### Methods

- [\_encodeForCall](SendTokenAndUnwrapAction.md#_encodeforcall)
- [\_formatType](SendTokenAndUnwrapAction.md#_formattype)
- [\_getArgumentMapping](SendTokenAndUnwrapAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](SendTokenAndUnwrapAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](SendTokenAndUnwrapAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](SendTokenAndUnwrapAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](SendTokenAndUnwrapAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](SendTokenAndUnwrapAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](SendTokenAndUnwrapAction.md#encodeforl2recipe)
- [encodeForRecipe](SendTokenAndUnwrapAction.md#encodeforrecipe)
- [encodeForStrategy](SendTokenAndUnwrapAction.md#encodeforstrategy)
- [getAccessList](SendTokenAndUnwrapAction.md#getaccesslist)
- [getAssetsToApprove](SendTokenAndUnwrapAction.md#getassetstoapprove)
- [getEthValue](SendTokenAndUnwrapAction.md#getethvalue)
- [getId](SendTokenAndUnwrapAction.md#getid)
...
| :------ | :------ | :------ |
| `token` | `string` | {string} Token address |
| `to` | `string` | {string} Transfer recipient |
| `amount` | `string` | {string} Transfer amount (-1 for whole Recipe (DsProxy) balance) |
...
[src/actions/basic/SendTokenAndUnwrapAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/SendTokenAndUnwrapAction.ts#L17)
