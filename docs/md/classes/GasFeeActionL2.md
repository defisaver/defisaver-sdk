[@defisaver/sdk](../README.md) / [Exports](../modules.md) / GasFeeActionL2

# Class: GasFeeActionL2
...
- [constructor](GasFeeActionL2.md#constructor)

### Properties

- [args](GasFeeActionL2.md#args)
- [contractAddress](GasFeeActionL2.md#contractaddress)
- [mappableArgs](GasFeeActionL2.md#mappableargs)
- [name](GasFeeActionL2.md#name)
- [paramTypes](GasFeeActionL2.md#paramtypes)

### Methods

- [\_encodeForCall](GasFeeActionL2.md#_encodeforcall)
- [\_formatType](GasFeeActionL2.md#_formattype)
- [\_getArgumentMapping](GasFeeActionL2.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](GasFeeActionL2.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](GasFeeActionL2.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](GasFeeActionL2.md#_replacewithplaceholders)
- [encodeForDsProxyCall](GasFeeActionL2.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](GasFeeActionL2.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](GasFeeActionL2.md#encodeforl2recipe)
- [encodeForRecipe](GasFeeActionL2.md#encodeforrecipe)
- [encodeForStrategy](GasFeeActionL2.md#encodeforstrategy)
- [getAccessList](GasFeeActionL2.md#getaccesslist)
- [getAssetsToApprove](GasFeeActionL2.md#getassetstoapprove)
- [getEthValue](GasFeeActionL2.md#getethvalue)
- [getId](GasFeeActionL2.md#getid)

## Constructors

### constructor

• **new GasFeeActionL2**(`gasStart`, `feeToken`, `availableAmount`, `dfsFeeDivider?`, `l1GasCostInEth?`)

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `gasStart` | `string` | `undefined` | {string} Always 0 will be inject value |
| `feeToken` | `string` | `undefined` | {string} Address of the token we are taken the fee in |
| `availableAmount` | `string` | `undefined` | Amount we have available to pay the gas fee |
| `dfsFeeDivider` | `string` | `'2000'` | Additional fee for DFS, default is 5bps |
| `l1GasCostInEth` | `string` | `'0'` | Additional tx cost for L1 in eth |
...
[src/actions/basic/GasFeeActionL2.ts:16](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/GasFeeActionL2.ts#L16)
