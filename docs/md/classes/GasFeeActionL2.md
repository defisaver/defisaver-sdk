...
| :------ | :------ | :------ | :------ |
| `gasStart` | `string` | `undefined` | Always 0 will be inject value |
| `feeToken` | `string` | `undefined` | Address of the token we are taken the fee in |
...
[src/actions/basic/GasFeeActionL2.ts:16](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/GasFeeActionL2.ts#L16)
