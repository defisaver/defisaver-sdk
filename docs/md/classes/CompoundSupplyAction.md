[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundSupplyAction

# Class: CompoundSupplyAction
...
- [constructor](CompoundSupplyAction.md#constructor)

### Properties

- [args](CompoundSupplyAction.md#args)
- [contractAddress](CompoundSupplyAction.md#contractaddress)
- [mappableArgs](CompoundSupplyAction.md#mappableargs)
- [name](CompoundSupplyAction.md#name)
- [paramTypes](CompoundSupplyAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundSupplyAction.md#_encodeforcall)
- [\_formatType](CompoundSupplyAction.md#_formattype)
- [\_getArgumentMapping](CompoundSupplyAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundSupplyAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundSupplyAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundSupplyAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundSupplyAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundSupplyAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundSupplyAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundSupplyAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundSupplyAction.md#encodeforstrategy)
- [getAccessList](CompoundSupplyAction.md#getaccesslist)
- [getAssetsToApprove](CompoundSupplyAction.md#getassetstoapprove)
- [getEthValue](CompoundSupplyAction.md#getethvalue)
- [getId](CompoundSupplyAction.md#getid)
...
| :------ | :------ | :------ | :------ |
| `cTokenAddr` | `string` | `undefined` | {EthAddress} |
| `amount` | `string` | `undefined` | {string} Wei amount in underlying asset decimals (not cAsset) - ie. 18 dec for cETH, not 8 |
| `from` | `string` | `undefined` | {EthAddress} |
| `enableAsColl` | `boolean` | `true` | {boolean} If we need to enable asset as collateral |
...
[src/actions/compound/CompoundSupplyAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compound/CompoundSupplyAction.ts#L18)
...
[src/actions/compound/CompoundSupplyAction.ts:28](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compound/CompoundSupplyAction.ts#L28)
