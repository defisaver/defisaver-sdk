...
| :------ | :------ | :------ | :------ |
| `cTokenAddr` | `string` | `undefined` |  |
| `amount` | `string` | `undefined` | Wei amount in underlying asset decimals (not cAsset) - ie. 18 dec for cETH, not 8 |
| `from` | `string` | `undefined` |  |
| `enableAsColl` | `boolean` | `true` | If we need to enable asset as collateral |
...
[src/actions/compound/CompoundSupplyAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundSupplyAction.ts#L18)
...
[src/actions/compound/CompoundSupplyAction.ts:28](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundSupplyAction.ts#L28)
