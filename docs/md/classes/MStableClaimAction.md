[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MStableClaimAction

# Class: MStableClaimAction
...
- [constructor](MStableClaimAction.md#constructor)

### Properties

- [args](MStableClaimAction.md#args)
- [contractAddress](MStableClaimAction.md#contractaddress)
- [mappableArgs](MStableClaimAction.md#mappableargs)
- [name](MStableClaimAction.md#name)
- [paramTypes](MStableClaimAction.md#paramtypes)

### Methods

- [\_encodeForCall](MStableClaimAction.md#_encodeforcall)
- [\_formatType](MStableClaimAction.md#_formattype)
- [\_getArgumentMapping](MStableClaimAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MStableClaimAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MStableClaimAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MStableClaimAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MStableClaimAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MStableClaimAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MStableClaimAction.md#encodeforl2recipe)
- [encodeForRecipe](MStableClaimAction.md#encodeforrecipe)
- [encodeForStrategy](MStableClaimAction.md#encodeforstrategy)
- [getAccessList](MStableClaimAction.md#getaccesslist)
- [getAssetsToApprove](MStableClaimAction.md#getassetstoapprove)
- [getEthValue](MStableClaimAction.md#getethvalue)
- [getId](MStableClaimAction.md#getid)
...
[src/actions/mstable/MStableClaimAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/mstable/MStableClaimAction.ts#L18)
