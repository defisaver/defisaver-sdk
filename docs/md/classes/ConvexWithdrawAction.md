[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ConvexWithdrawAction

# Class: ConvexWithdrawAction
...
- [constructor](ConvexWithdrawAction.md#constructor)

### Properties

- [args](ConvexWithdrawAction.md#args)
- [contractAddress](ConvexWithdrawAction.md#contractaddress)
- [curveLp](ConvexWithdrawAction.md#curvelp)
- [mappableArgs](ConvexWithdrawAction.md#mappableargs)
- [name](ConvexWithdrawAction.md#name)
- [paramTypes](ConvexWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](ConvexWithdrawAction.md#_encodeforcall)
- [\_formatType](ConvexWithdrawAction.md#_formattype)
- [\_getArgumentMapping](ConvexWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ConvexWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ConvexWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ConvexWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ConvexWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ConvexWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ConvexWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](ConvexWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](ConvexWithdrawAction.md#encodeforstrategy)
- [getAccessList](ConvexWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](ConvexWithdrawAction.md#getassetstoapprove)
- [getEthValue](ConvexWithdrawAction.md#getethvalue)
- [getId](ConvexWithdrawAction.md#getid)

## Constructors

### constructor

• **new ConvexWithdrawAction**(`from`, `to`, `curveLp`, `amount`, `option`)
...
[src/actions/convex/ConvexWithdrawAction.ts:22](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/convex/ConvexWithdrawAction.ts#L22)
...
[src/actions/convex/ConvexWithdrawAction.ts:13](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/convex/ConvexWithdrawAction.ts#L13)
...
▸ **getAssetsToApprove**(): `Promise`<{ `asset`: `string` = pool.token; `owner`: `any`  }[]\>
...
`Promise`<{ `asset`: `string` = pool.token; `owner`: `any`  }[]\>
...
[src/actions/convex/ConvexWithdrawAction.ts:61](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/convex/ConvexWithdrawAction.ts#L61)
