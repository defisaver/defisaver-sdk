[@defisaver/sdk](../README.md) / [Exports](../modules.md) / GasFeeAction
...
- [constructor](GasFeeAction.md#constructor)

### Properties

- [args](GasFeeAction.md#args)
- [contractAddress](GasFeeAction.md#contractaddress)
- [mappableArgs](GasFeeAction.md#mappableargs)
- [name](GasFeeAction.md#name)
- [paramTypes](GasFeeAction.md#paramtypes)

### Methods

- [\_encodeForCall](GasFeeAction.md#_encodeforcall)
- [\_formatType](GasFeeAction.md#_formattype)
- [\_getArgumentMapping](GasFeeAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](GasFeeAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](GasFeeAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](GasFeeAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](GasFeeAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](GasFeeAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](GasFeeAction.md#encodeforl2recipe)
- [encodeForRecipe](GasFeeAction.md#encodeforrecipe)
- [encodeForStrategy](GasFeeAction.md#encodeforstrategy)
- [getAccessList](GasFeeAction.md#getaccesslist)
- [getAssetsToApprove](GasFeeAction.md#getassetstoapprove)
- [getEthValue](GasFeeAction.md#getethvalue)
- [getId](GasFeeAction.md#getid)
...
[src/actions/basic/GasFeeAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/GasFeeAction.ts#L15)
