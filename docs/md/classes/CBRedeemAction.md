...
| :------ | :------ | :------ |
| `bLUSDAmount` | `string` | Amount of bLUSD |
| `minLUSDFromSP` | `string` | Min amount of lusd to receive |
| `from` | `string` |  |
| `to` | `string` |  |
...
[src/actions/chickenBonds/CBRedeemAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/chickenBonds/CBRedeemAction.ts#L18)
...
[src/actions/chickenBonds/CBRedeemAction.ts:24](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/chickenBonds/CBRedeemAction.ts#L24)
