[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CBRedeemAction

# Class: CBRedeemAction
...
- [constructor](CBRedeemAction.md#constructor)

### Properties

- [args](CBRedeemAction.md#args)
- [contractAddress](CBRedeemAction.md#contractaddress)
- [mappableArgs](CBRedeemAction.md#mappableargs)
- [name](CBRedeemAction.md#name)
- [paramTypes](CBRedeemAction.md#paramtypes)

### Methods

- [\_encodeForCall](CBRedeemAction.md#_encodeforcall)
- [\_formatType](CBRedeemAction.md#_formattype)
- [\_getArgumentMapping](CBRedeemAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CBRedeemAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CBRedeemAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CBRedeemAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CBRedeemAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CBRedeemAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CBRedeemAction.md#encodeforl2recipe)
- [encodeForRecipe](CBRedeemAction.md#encodeforrecipe)
- [encodeForStrategy](CBRedeemAction.md#encodeforstrategy)
- [getAccessList](CBRedeemAction.md#getaccesslist)
- [getAssetsToApprove](CBRedeemAction.md#getassetstoapprove)
- [getEthValue](CBRedeemAction.md#getethvalue)
- [getId](CBRedeemAction.md#getid)

## Constructors

### constructor

• **new CBRedeemAction**(`bLUSDAmount`, `minLUSDFromSP`, `from`, `to`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `bLUSDAmount` | `string` | {string} Amount of bLUSD |
| `minLUSDFromSP` | `string` | {string} Min amount of lusd to receive |
...
[src/actions/chickenBonds/CBRedeemAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/chickenBonds/CBRedeemAction.ts#L18)
...
[src/actions/chickenBonds/CBRedeemAction.ts:24](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/chickenBonds/CBRedeemAction.ts#L24)
