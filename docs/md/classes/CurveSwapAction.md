[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveSwapAction

# Class: CurveSwapAction
...
- [constructor](CurveSwapAction.md#constructor)

### Properties

- [args](CurveSwapAction.md#args)
- [contractAddress](CurveSwapAction.md#contractaddress)
- [mappableArgs](CurveSwapAction.md#mappableargs)
- [name](CurveSwapAction.md#name)
- [paramTypes](CurveSwapAction.md#paramtypes)

### Methods

- [\_encodeForCall](CurveSwapAction.md#_encodeforcall)
- [\_formatType](CurveSwapAction.md#_formattype)
- [\_getArgumentMapping](CurveSwapAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveSwapAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveSwapAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveSwapAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveSwapAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveSwapAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveSwapAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveSwapAction.md#encodeforrecipe)
- [encodeForStrategy](CurveSwapAction.md#encodeforstrategy)
- [getAccessList](CurveSwapAction.md#getaccesslist)
- [getAssetsToApprove](CurveSwapAction.md#getassetstoapprove)
- [getEthValue](CurveSwapAction.md#getethvalue)
- [getId](CurveSwapAction.md#getid)
...
[src/actions/curve/CurveSwapAction.ts:21](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/curve/CurveSwapAction.ts#L21)
...
[src/actions/curve/CurveSwapAction.ts:37](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/curve/CurveSwapAction.ts#L37)
