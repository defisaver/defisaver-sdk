[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CBCreateAction

# Class: CBCreateAction
...
- [constructor](CBCreateAction.md#constructor)

### Properties

- [args](CBCreateAction.md#args)
- [contractAddress](CBCreateAction.md#contractaddress)
- [mappableArgs](CBCreateAction.md#mappableargs)
- [name](CBCreateAction.md#name)
- [paramTypes](CBCreateAction.md#paramtypes)

### Methods

- [\_encodeForCall](CBCreateAction.md#_encodeforcall)
- [\_formatType](CBCreateAction.md#_formattype)
- [\_getArgumentMapping](CBCreateAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CBCreateAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CBCreateAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CBCreateAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CBCreateAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CBCreateAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CBCreateAction.md#encodeforl2recipe)
- [encodeForRecipe](CBCreateAction.md#encodeforrecipe)
- [encodeForStrategy](CBCreateAction.md#encodeforstrategy)
- [getAccessList](CBCreateAction.md#getaccesslist)
- [getAssetsToApprove](CBCreateAction.md#getassetstoapprove)
- [getEthValue](CBCreateAction.md#getethvalue)
- [getId](CBCreateAction.md#getid)

## Constructors

### constructor

• **new CBCreateAction**(`amount`, `from`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `amount` | `string` | {string} Wei amount in LUSD |
...
[src/actions/chickenBonds/CBCreateAction.ts:16](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/chickenBonds/CBCreateAction.ts#L16)
...
[src/actions/chickenBonds/CBCreateAction.ts:21](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/chickenBonds/CBCreateAction.ts#L21)
