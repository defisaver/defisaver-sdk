[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3SetEModeAction
...
- [constructor](AaveV3SetEModeAction.md#constructor)

### Properties

- [args](AaveV3SetEModeAction.md#args)
- [contractAddress](AaveV3SetEModeAction.md#contractaddress)
- [mappableArgs](AaveV3SetEModeAction.md#mappableargs)
- [name](AaveV3SetEModeAction.md#name)
- [paramTypes](AaveV3SetEModeAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveV3SetEModeAction.md#_encodeforcall)
- [\_formatType](AaveV3SetEModeAction.md#_formattype)
- [\_getArgumentMapping](AaveV3SetEModeAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV3SetEModeAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV3SetEModeAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV3SetEModeAction.md#_replacewithplaceholders)
- [addressToBytes20](AaveV3SetEModeAction.md#addresstobytes20)
- [boolToBytes1](AaveV3SetEModeAction.md#booltobytes1)
- [encodeForDsProxyCall](AaveV3SetEModeAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV3SetEModeAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV3SetEModeAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveV3SetEModeAction.md#encodeforrecipe)
- [encodeForStrategy](AaveV3SetEModeAction.md#encodeforstrategy)
- [encodeInputs](AaveV3SetEModeAction.md#encodeinputs)
- [getAccessList](AaveV3SetEModeAction.md#getaccesslist)
- [getAssetsToApprove](AaveV3SetEModeAction.md#getassetstoapprove)
- [getEthValue](AaveV3SetEModeAction.md#getethvalue)
- [getId](AaveV3SetEModeAction.md#getid)
- [numberToBytes1](AaveV3SetEModeAction.md#numbertobytes1)
- [numberToBytes2](AaveV3SetEModeAction.md#numbertobytes2)
- [numberToBytes32](AaveV3SetEModeAction.md#numbertobytes32)

## Constructors

### constructor

• **new AaveV3SetEModeAction**(`useOnDefaultMarket`, `market`, `categoryId`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `useOnDefaultMarket` | `boolean` | {boolean} If this is true it defaults to the hardcoded market in contract |
| `market` | `string` | {EthAddress} Address provider for specific market |
| `categoryId` | `string` | {EthAddress} ID of the category emode |
...
[src/actions/aaveV3/AaveV3SetEModeAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SetEModeAction.ts#L15)
...
[src/actions/aaveV3/AaveV3SetEModeAction.ts:25](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3SetEModeAction.ts#L25)
