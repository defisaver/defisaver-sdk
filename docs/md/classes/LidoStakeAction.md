[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LidoStakeAction
...
| :------ | :------ | :------ |
| `amount` | `string` | {string} amount of WETH to pull and stake |
| `from` | `string` | {EthAddress} WETH will be taken from this address |
| `to` | `string` | {EthAddress} stETH will be sent to this address |
...
[src/actions/lido/LidoStakeAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/lido/LidoStakeAction.ts#L18)
...
[src/actions/lido/LidoStakeAction.ts:23](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/lido/LidoStakeAction.ts#L23)
