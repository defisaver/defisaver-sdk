[@defisaver/sdk](../README.md) / [Exports](../modules.md) / TrailingStopTrigger
...
- [constructor](TrailingStopTrigger.md#constructor)

### Properties

- [args](TrailingStopTrigger.md#args)
- [contractAddress](TrailingStopTrigger.md#contractaddress)
- [mappableArgs](TrailingStopTrigger.md#mappableargs)
- [name](TrailingStopTrigger.md#name)
- [paramTypes](TrailingStopTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](TrailingStopTrigger.md#_encodeforcall)
- [\_formatType](TrailingStopTrigger.md#_formattype)
- [\_getArgumentMapping](TrailingStopTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](TrailingStopTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](TrailingStopTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](TrailingStopTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](TrailingStopTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](TrailingStopTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](TrailingStopTrigger.md#encodeforl2recipe)
- [encodeForRecipe](TrailingStopTrigger.md#encodeforrecipe)
- [encodeForStrategy](TrailingStopTrigger.md#encodeforstrategy)
- [getAccessList](TrailingStopTrigger.md#getaccesslist)
- [getAssetsToApprove](TrailingStopTrigger.md#getassetstoapprove)
- [getEthValue](TrailingStopTrigger.md#getethvalue)
- [getId](TrailingStopTrigger.md#getid)

## Constructors

### constructor

• **new TrailingStopTrigger**(`tokenAddr`, `percentage`, `roundId`)
...
[src/triggers/TrailingStopTrigger.ts:11](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/TrailingStopTrigger.ts#L11)
