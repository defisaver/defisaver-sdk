[@defisaver/sdk](../README.md) / [Exports](../modules.md) / UpdateSubAction
...
- [constructor](UpdateSubAction.md#constructor)

### Properties

- [args](UpdateSubAction.md#args)
- [contractAddress](UpdateSubAction.md#contractaddress)
- [mappableArgs](UpdateSubAction.md#mappableargs)
- [name](UpdateSubAction.md#name)
- [paramTypes](UpdateSubAction.md#paramtypes)

### Methods

- [\_encodeForCall](UpdateSubAction.md#_encodeforcall)
- [\_formatType](UpdateSubAction.md#_formattype)
- [\_getArgumentMapping](UpdateSubAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](UpdateSubAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](UpdateSubAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](UpdateSubAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](UpdateSubAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](UpdateSubAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](UpdateSubAction.md#encodeforl2recipe)
- [encodeForRecipe](UpdateSubAction.md#encodeforrecipe)
- [encodeForStrategy](UpdateSubAction.md#encodeforstrategy)
- [getAccessList](UpdateSubAction.md#getaccesslist)
- [getAssetsToApprove](UpdateSubAction.md#getassetstoapprove)
- [getEthValue](UpdateSubAction.md#getethvalue)
- [getId](UpdateSubAction.md#getid)
...
| `sub` | [`string`, `boolean`, [`bytes`](../modules.md#bytes)[], `string`[]] | object that contains new sub information |
...
[src/actions/basic/UpdateSubAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/UpdateSubAction.ts#L15)
