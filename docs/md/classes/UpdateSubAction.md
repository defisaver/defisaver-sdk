...
| `sub` | [`string`, `boolean`, `bytes`[], `string`[]] | object that contains new sub information |
...
[src/actions/basic/UpdateSubAction.ts:15](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/UpdateSubAction.ts#L15)
