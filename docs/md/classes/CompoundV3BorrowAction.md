...
| `amount` | `string` | Wei amount in underlying asset decimals |
| `to` | `string` | Address where we send the borrowed tokens |
| `onBehalf` | `string` | Address from which we are borrowing the tokens |
...
[src/actions/compoundV3/CompoundV3BorrowAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3BorrowAction.ts#L18)
