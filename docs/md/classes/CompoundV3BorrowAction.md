[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundV3BorrowAction

# Class: CompoundV3BorrowAction
...
- [constructor](CompoundV3BorrowAction.md#constructor)

### Properties

- [args](CompoundV3BorrowAction.md#args)
- [contractAddress](CompoundV3BorrowAction.md#contractaddress)
- [mappableArgs](CompoundV3BorrowAction.md#mappableargs)
- [name](CompoundV3BorrowAction.md#name)
- [paramTypes](CompoundV3BorrowAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundV3BorrowAction.md#_encodeforcall)
- [\_formatType](CompoundV3BorrowAction.md#_formattype)
- [\_getArgumentMapping](CompoundV3BorrowAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundV3BorrowAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundV3BorrowAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundV3BorrowAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundV3BorrowAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundV3BorrowAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundV3BorrowAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundV3BorrowAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundV3BorrowAction.md#encodeforstrategy)
- [getAccessList](CompoundV3BorrowAction.md#getaccesslist)
- [getAssetsToApprove](CompoundV3BorrowAction.md#getassetstoapprove)
- [getEthValue](CompoundV3BorrowAction.md#getethvalue)
- [getId](CompoundV3BorrowAction.md#getid)

## Constructors

### constructor

• **new CompoundV3BorrowAction**(`market`, `amount`, `to`, `onBehalf`)
...
| `amount` | `string` | {string} Wei amount in underlying asset decimals |
| `to` | `string` | {EthAddress} Address where we send the borrowed tokens |
| `onBehalf` | `string` | {EthAddress} Address from which we are borrowing the tokens |
...
[src/actions/compoundV3/CompoundV3BorrowAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compoundV3/CompoundV3BorrowAction.ts#L18)
