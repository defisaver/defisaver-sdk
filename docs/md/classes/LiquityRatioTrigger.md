[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityRatioTrigger

# Class: LiquityRatioTrigger
...
- [constructor](LiquityRatioTrigger.md#constructor)

### Properties

- [args](LiquityRatioTrigger.md#args)
- [contractAddress](LiquityRatioTrigger.md#contractaddress)
- [mappableArgs](LiquityRatioTrigger.md#mappableargs)
- [name](LiquityRatioTrigger.md#name)
- [paramTypes](LiquityRatioTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityRatioTrigger.md#_encodeforcall)
- [\_formatType](LiquityRatioTrigger.md#_formattype)
- [\_getArgumentMapping](LiquityRatioTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityRatioTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityRatioTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityRatioTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityRatioTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityRatioTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityRatioTrigger.md#encodeforl2recipe)
- [encodeForRecipe](LiquityRatioTrigger.md#encodeforrecipe)
- [encodeForStrategy](LiquityRatioTrigger.md#encodeforstrategy)
- [getAccessList](LiquityRatioTrigger.md#getaccesslist)
- [getAssetsToApprove](LiquityRatioTrigger.md#getassetstoapprove)
- [getEthValue](LiquityRatioTrigger.md#getethvalue)
- [getId](LiquityRatioTrigger.md#getid)

## Constructors

### constructor

• **new LiquityRatioTrigger**(`troveOwner`, `ratio`, `state`)
...
[src/triggers/LiquityRatioTrigger.ts:12](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/LiquityRatioTrigger.ts#L12)
