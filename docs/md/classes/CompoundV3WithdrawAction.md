...
| `to` | `string` | {EthAddress} Address where we are sending the tokens |
| `asset` | `string` | {EthAddress} Address of asset to withdraw |
| `amount` | `string` | {string} Wei amount in specified asset |
| `onBehalf` | `string` | {EthAddress} Address from where we are withdrawing the tokens |
...
[src/actions/compoundV3/CompoundV3WithdrawAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/compoundV3/CompoundV3WithdrawAction.ts#L19)
