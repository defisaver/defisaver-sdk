[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundV3WithdrawAction

# Class: CompoundV3WithdrawAction
...
- [constructor](CompoundV3WithdrawAction.md#constructor)

### Properties

- [args](CompoundV3WithdrawAction.md#args)
- [contractAddress](CompoundV3WithdrawAction.md#contractaddress)
- [mappableArgs](CompoundV3WithdrawAction.md#mappableargs)
- [name](CompoundV3WithdrawAction.md#name)
- [paramTypes](CompoundV3WithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundV3WithdrawAction.md#_encodeforcall)
- [\_formatType](CompoundV3WithdrawAction.md#_formattype)
- [\_getArgumentMapping](CompoundV3WithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundV3WithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundV3WithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundV3WithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundV3WithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundV3WithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundV3WithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundV3WithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundV3WithdrawAction.md#encodeforstrategy)
- [getAccessList](CompoundV3WithdrawAction.md#getaccesslist)
- [getAssetsToApprove](CompoundV3WithdrawAction.md#getassetstoapprove)
- [getEthValue](CompoundV3WithdrawAction.md#getethvalue)
- [getId](CompoundV3WithdrawAction.md#getid)

## Constructors

### constructor

• **new CompoundV3WithdrawAction**(`market`, `to`, `asset`, `amount`, `onBehalf`)
...
| `to` | `string` | Address where we are sending the tokens |
| `asset` | `string` | Address of asset to withdraw |
| `amount` | `string` | Wei amount in specified asset |
| `onBehalf` | `string` | Address from where we are withdrawing the tokens |
...
[src/actions/compoundV3/CompoundV3WithdrawAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compoundV3/CompoundV3WithdrawAction.ts#L19)
