[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquitySPDepositAction

# Class: LiquitySPDepositAction
...
- [constructor](LiquitySPDepositAction.md#constructor)

### Properties

- [args](LiquitySPDepositAction.md#args)
- [contractAddress](LiquitySPDepositAction.md#contractaddress)
- [mappableArgs](LiquitySPDepositAction.md#mappableargs)
- [name](LiquitySPDepositAction.md#name)
- [paramTypes](LiquitySPDepositAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquitySPDepositAction.md#_encodeforcall)
- [\_formatType](LiquitySPDepositAction.md#_formattype)
- [\_getArgumentMapping](LiquitySPDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquitySPDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquitySPDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquitySPDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquitySPDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquitySPDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquitySPDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquitySPDepositAction.md#encodeforrecipe)
- [encodeForStrategy](LiquitySPDepositAction.md#encodeforstrategy)
- [getAccessList](LiquitySPDepositAction.md#getaccesslist)
- [getAssetsToApprove](LiquitySPDepositAction.md#getassetstoapprove)
- [getEthValue](LiquitySPDepositAction.md#getethvalue)
- [getId](LiquitySPDepositAction.md#getid)
...
| :------ | :------ | :------ |
| `lusdAmount` | `string` | Amount of LUSD tokens to deposit |
| `from` | `string` | Address where the tokens are being pulled from |
...
[src/actions/liquity/LiquitySPDepositAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquitySPDepositAction.ts#L18)
...
[src/actions/liquity/LiquitySPDepositAction.ts:35](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquitySPDepositAction.ts#L35)
