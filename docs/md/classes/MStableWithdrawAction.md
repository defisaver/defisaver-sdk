[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MStableWithdrawAction

# Class: MStableWithdrawAction
...
- [constructor](MStableWithdrawAction.md#constructor)

### Properties

- [args](MStableWithdrawAction.md#args)
- [contractAddress](MStableWithdrawAction.md#contractaddress)
- [mappableArgs](MStableWithdrawAction.md#mappableargs)
- [name](MStableWithdrawAction.md#name)
- [paramTypes](MStableWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](MStableWithdrawAction.md#_encodeforcall)
- [\_formatType](MStableWithdrawAction.md#_formattype)
- [\_getArgumentMapping](MStableWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MStableWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MStableWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MStableWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MStableWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MStableWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MStableWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](MStableWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](MStableWithdrawAction.md#encodeforstrategy)
- [getAccessList](MStableWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](MStableWithdrawAction.md#getassetstoapprove)
- [getEthValue](MStableWithdrawAction.md#getethvalue)
- [getId](MStableWithdrawAction.md#getid)
...
[src/actions/mstable/MStableWithdrawAction.ts:24](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/mstable/MStableWithdrawAction.ts#L24)
...
[src/actions/mstable/MStableWithdrawAction.ts:62](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/mstable/MStableWithdrawAction.ts#L62)
