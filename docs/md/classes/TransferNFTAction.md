[@defisaver/sdk](../README.md) / [Exports](../modules.md) / TransferNFTAction
...
- [constructor](TransferNFTAction.md#constructor)

### Properties

- [args](TransferNFTAction.md#args)
- [contractAddress](TransferNFTAction.md#contractaddress)
- [mappableArgs](TransferNFTAction.md#mappableargs)
- [name](TransferNFTAction.md#name)
- [paramTypes](TransferNFTAction.md#paramtypes)

### Methods

- [\_encodeForCall](TransferNFTAction.md#_encodeforcall)
- [\_formatType](TransferNFTAction.md#_formattype)
- [\_getArgumentMapping](TransferNFTAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](TransferNFTAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](TransferNFTAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](TransferNFTAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](TransferNFTAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](TransferNFTAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](TransferNFTAction.md#encodeforl2recipe)
- [encodeForRecipe](TransferNFTAction.md#encodeforrecipe)
- [encodeForStrategy](TransferNFTAction.md#encodeforstrategy)
- [getAccessList](TransferNFTAction.md#getaccesslist)
- [getAssetsToApprove](TransferNFTAction.md#getassetstoapprove)
- [getEthValue](TransferNFTAction.md#getethvalue)
- [getId](TransferNFTAction.md#getid)

## Constructors

### constructor

• **new TransferNFTAction**(`nftAddr`, `from`, `to`, `nftId`)
...
[src/actions/basic/TransferNFTAction.ts:9](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/basic/TransferNFTAction.ts#L9)
