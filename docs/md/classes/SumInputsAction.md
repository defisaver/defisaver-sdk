[@defisaver/sdk](../README.md) / [Exports](../modules.md) / SumInputsAction

# Class: SumInputsAction
...
- [constructor](SumInputsAction.md#constructor)

### Properties

- [args](SumInputsAction.md#args)
- [contractAddress](SumInputsAction.md#contractaddress)
- [mappableArgs](SumInputsAction.md#mappableargs)
- [name](SumInputsAction.md#name)
- [paramTypes](SumInputsAction.md#paramtypes)

### Methods

- [\_encodeForCall](SumInputsAction.md#_encodeforcall)
- [\_formatType](SumInputsAction.md#_formattype)
- [\_getArgumentMapping](SumInputsAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](SumInputsAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](SumInputsAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](SumInputsAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](SumInputsAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](SumInputsAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](SumInputsAction.md#encodeforl2recipe)
- [encodeForRecipe](SumInputsAction.md#encodeforrecipe)
- [encodeForStrategy](SumInputsAction.md#encodeforstrategy)
- [getAccessList](SumInputsAction.md#getaccesslist)
- [getAssetsToApprove](SumInputsAction.md#getassetstoapprove)
- [getEthValue](SumInputsAction.md#getethvalue)
- [getId](SumInputsAction.md#getid)

## Constructors

### constructor

• **new SumInputsAction**(`a`, `b`)
...
[src/actions/basic/SumInputsAction.ts:11](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/SumInputsAction.ts#L11)
