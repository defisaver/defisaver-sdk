[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerFlashLoanAction

# Class: MakerFlashLoanAction
...
- [constructor](MakerFlashLoanAction.md#constructor)

### Properties

- [args](MakerFlashLoanAction.md#args)
- [contractAddress](MakerFlashLoanAction.md#contractaddress)
- [mappableArgs](MakerFlashLoanAction.md#mappableargs)
- [name](MakerFlashLoanAction.md#name)
- [paramTypes](MakerFlashLoanAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerFlashLoanAction.md#_encodeforcall)
- [\_formatType](MakerFlashLoanAction.md#_formattype)
- [\_getArgumentMapping](MakerFlashLoanAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerFlashLoanAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerFlashLoanAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerFlashLoanAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerFlashLoanAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerFlashLoanAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerFlashLoanAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerFlashLoanAction.md#encodeforrecipe)
- [encodeForStrategy](MakerFlashLoanAction.md#encodeforstrategy)
- [getAccessList](MakerFlashLoanAction.md#getaccesslist)
- [getAssetsToApprove](MakerFlashLoanAction.md#getassetstoapprove)
- [getEthValue](MakerFlashLoanAction.md#getethvalue)
- [getId](MakerFlashLoanAction.md#getid)
...
[src/actions/flashloan/MakerFlashLoanAction.ts:16](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/flashloan/MakerFlashLoanAction.ts#L16)
