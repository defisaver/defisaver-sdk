[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundCollateralSwitchAction

# Class: CompoundCollateralSwitchAction
...
- [constructor](CompoundCollateralSwitchAction.md#constructor)

### Properties

- [args](CompoundCollateralSwitchAction.md#args)
- [contractAddress](CompoundCollateralSwitchAction.md#contractaddress)
- [mappableArgs](CompoundCollateralSwitchAction.md#mappableargs)
- [name](CompoundCollateralSwitchAction.md#name)
- [paramTypes](CompoundCollateralSwitchAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundCollateralSwitchAction.md#_encodeforcall)
- [\_formatType](CompoundCollateralSwitchAction.md#_formattype)
- [\_getArgumentMapping](CompoundCollateralSwitchAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundCollateralSwitchAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundCollateralSwitchAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundCollateralSwitchAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundCollateralSwitchAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundCollateralSwitchAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundCollateralSwitchAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundCollateralSwitchAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundCollateralSwitchAction.md#encodeforstrategy)
- [getAccessList](CompoundCollateralSwitchAction.md#getaccesslist)
- [getAssetsToApprove](CompoundCollateralSwitchAction.md#getassetstoapprove)
- [getEthValue](CompoundCollateralSwitchAction.md#getethvalue)
- [getId](CompoundCollateralSwitchAction.md#getid)

## Constructors

### constructor

• **new CompoundCollateralSwitchAction**(`cTokens`, `useAsCollateral`)
...
[src/actions/compound/CompoundCollateralSwitchAction.ts:11](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundCollateralSwitchAction.ts#L11)
