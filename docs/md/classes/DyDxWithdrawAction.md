[@defisaver/sdk](../README.md) / [Exports](../modules.md) / DyDxWithdrawAction

# Class: DyDxWithdrawAction
...
- [constructor](DyDxWithdrawAction.md#constructor)

### Properties

- [args](DyDxWithdrawAction.md#args)
- [contractAddress](DyDxWithdrawAction.md#contractaddress)
- [mappableArgs](DyDxWithdrawAction.md#mappableargs)
- [name](DyDxWithdrawAction.md#name)
- [paramTypes](DyDxWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](DyDxWithdrawAction.md#_encodeforcall)
- [\_formatType](DyDxWithdrawAction.md#_formattype)
- [\_getArgumentMapping](DyDxWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](DyDxWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](DyDxWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](DyDxWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](DyDxWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](DyDxWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](DyDxWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](DyDxWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](DyDxWithdrawAction.md#encodeforstrategy)
- [getAccessList](DyDxWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](DyDxWithdrawAction.md#getassetstoapprove)
- [getEthValue](DyDxWithdrawAction.md#getethvalue)
- [getId](DyDxWithdrawAction.md#getid)
...
| `to` | `string` | {EthAddress} Tokens will be withdrawn to this address |
...
[src/actions/dydx/DyDxWithdrawAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/dydx/DyDxWithdrawAction.ts#L17)
