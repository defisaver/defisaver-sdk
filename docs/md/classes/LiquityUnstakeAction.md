[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityUnstakeAction

# Class: LiquityUnstakeAction
...
- [`Action`](Action.md)
  ...
  ↳↳ [`LiquityClaimStakingRewardsAction`](LiquityClaimStakingRewardsAction.md)

## Table of contents

### Constructors

- [constructor](LiquityUnstakeAction.md#constructor)

### Properties

- [args](LiquityUnstakeAction.md#args)
- [contractAddress](LiquityUnstakeAction.md#contractaddress)
- [mappableArgs](LiquityUnstakeAction.md#mappableargs)
- [name](LiquityUnstakeAction.md#name)
- [paramTypes](LiquityUnstakeAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityUnstakeAction.md#_encodeforcall)
- [\_formatType](LiquityUnstakeAction.md#_formattype)
- [\_getArgumentMapping](LiquityUnstakeAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityUnstakeAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityUnstakeAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityUnstakeAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityUnstakeAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityUnstakeAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityUnstakeAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityUnstakeAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityUnstakeAction.md#encodeforstrategy)
- [getAccessList](LiquityUnstakeAction.md#getaccesslist)
- [getAssetsToApprove](LiquityUnstakeAction.md#getassetstoapprove)
- [getEthValue](LiquityUnstakeAction.md#getethvalue)
- [getId](LiquityUnstakeAction.md#getid)
...
| :------ | :------ | :------ |
| `lqtyAmount` | `string` | Amount of LQTY tokens that will be unstaked |
| `to` | `string` | Address that will receive the tokens |
...
[src/actions/liquity/LiquityUnstakeAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquityUnstakeAction.ts#L18)
