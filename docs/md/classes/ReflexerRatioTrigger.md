[@defisaver/sdk](../README.md) / [Exports](../modules.md) / ReflexerRatioTrigger

# Class: ReflexerRatioTrigger
...
- [constructor](ReflexerRatioTrigger.md#constructor)

### Properties

- [args](ReflexerRatioTrigger.md#args)
- [contractAddress](ReflexerRatioTrigger.md#contractaddress)
- [mappableArgs](ReflexerRatioTrigger.md#mappableargs)
- [name](ReflexerRatioTrigger.md#name)
- [paramTypes](ReflexerRatioTrigger.md#paramtypes)

### Methods

- [\_encodeForCall](ReflexerRatioTrigger.md#_encodeforcall)
- [\_formatType](ReflexerRatioTrigger.md#_formattype)
- [\_getArgumentMapping](ReflexerRatioTrigger.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](ReflexerRatioTrigger.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](ReflexerRatioTrigger.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](ReflexerRatioTrigger.md#_replacewithplaceholders)
- [encodeForDsProxyCall](ReflexerRatioTrigger.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](ReflexerRatioTrigger.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](ReflexerRatioTrigger.md#encodeforl2recipe)
- [encodeForRecipe](ReflexerRatioTrigger.md#encodeforrecipe)
- [encodeForStrategy](ReflexerRatioTrigger.md#encodeforstrategy)
- [getAccessList](ReflexerRatioTrigger.md#getaccesslist)
- [getAssetsToApprove](ReflexerRatioTrigger.md#getassetstoapprove)
- [getEthValue](ReflexerRatioTrigger.md#getethvalue)
- [getId](ReflexerRatioTrigger.md#getid)

## Constructors

### constructor

• **new ReflexerRatioTrigger**(`vaultId`, `ratio`, `state`)
...
[src/triggers/ReflexerRatioTrigger.ts:12](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/triggers/ReflexerRatioTrigger.ts#L12)
