[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CurveDepositAction

# Class: CurveDepositAction
...
- [constructor](CurveDepositAction.md#constructor)

### Properties

- [args](CurveDepositAction.md#args)
- [contractAddress](CurveDepositAction.md#contractaddress)
- [mappableArgs](CurveDepositAction.md#mappableargs)
- [name](CurveDepositAction.md#name)
- [paramTypes](CurveDepositAction.md#paramtypes)
- [tokensForApproval](CurveDepositAction.md#tokensforapproval)

### Methods

- [\_encodeForCall](CurveDepositAction.md#_encodeforcall)
- [\_formatType](CurveDepositAction.md#_formattype)
- [\_getArgumentMapping](CurveDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CurveDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CurveDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CurveDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CurveDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CurveDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CurveDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](CurveDepositAction.md#encodeforrecipe)
- [encodeForStrategy](CurveDepositAction.md#encodeforstrategy)
- [getAccessList](CurveDepositAction.md#getaccesslist)
- [getAssetsToApprove](CurveDepositAction.md#getassetstoapprove)
- [getEthValue](CurveDepositAction.md#getethvalue)
- [getId](CurveDepositAction.md#getid)

## Constructors

### constructor

• **new CurveDepositAction**(`sender`, `receiver`, `poolAddr`, `minMintAmount`, `useUnderlying`, `amounts?`)
...
| `minMintAmount` | `string` | `undefined` |
...
[src/actions/curve/CurveDepositAction.ts:23](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveDepositAction.ts#L23)
...
• **tokensForApproval**: `string`[]

#### Defined in

[src/actions/curve/CurveDepositAction.ts:13](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveDepositAction.ts#L13)
...
[src/actions/curve/CurveDepositAction.ts:79](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/curve/CurveDepositAction.ts#L79)
