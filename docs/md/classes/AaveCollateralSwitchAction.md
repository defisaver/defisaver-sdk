[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveCollateralSwitchAction

# Class: AaveCollateralSwitchAction
...
- [constructor](AaveCollateralSwitchAction.md#constructor)

### Properties

- [args](AaveCollateralSwitchAction.md#args)
- [contractAddress](AaveCollateralSwitchAction.md#contractaddress)
- [mappableArgs](AaveCollateralSwitchAction.md#mappableargs)
- [name](AaveCollateralSwitchAction.md#name)
- [paramTypes](AaveCollateralSwitchAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveCollateralSwitchAction.md#_encodeforcall)
- [\_formatType](AaveCollateralSwitchAction.md#_formattype)
- [\_getArgumentMapping](AaveCollateralSwitchAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveCollateralSwitchAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveCollateralSwitchAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveCollateralSwitchAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveCollateralSwitchAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveCollateralSwitchAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveCollateralSwitchAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveCollateralSwitchAction.md#encodeforrecipe)
- [encodeForStrategy](AaveCollateralSwitchAction.md#encodeforstrategy)
- [getAccessList](AaveCollateralSwitchAction.md#getaccesslist)
- [getAssetsToApprove](AaveCollateralSwitchAction.md#getassetstoapprove)
- [getEthValue](AaveCollateralSwitchAction.md#getethvalue)
- [getId](AaveCollateralSwitchAction.md#getid)

## Constructors

### constructor

• **new AaveCollateralSwitchAction**(`market`, `tokens`, `useAsCollateral`)
...
[src/actions/aave/AaveCollateralSwitchAction.ts:16](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aave/AaveCollateralSwitchAction.ts#L16)
