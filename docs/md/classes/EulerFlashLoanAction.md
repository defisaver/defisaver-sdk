[@defisaver/sdk](../README.md) / [Exports](../modules.md) / EulerFlashLoanAction

# Class: EulerFlashLoanAction
...
- [constructor](EulerFlashLoanAction.md#constructor)

### Properties

- [args](EulerFlashLoanAction.md#args)
- [contractAddress](EulerFlashLoanAction.md#contractaddress)
- [mappableArgs](EulerFlashLoanAction.md#mappableargs)
- [name](EulerFlashLoanAction.md#name)
- [paramTypes](EulerFlashLoanAction.md#paramtypes)

### Methods

- [\_encodeForCall](EulerFlashLoanAction.md#_encodeforcall)
- [\_formatType](EulerFlashLoanAction.md#_formattype)
- [\_getArgumentMapping](EulerFlashLoanAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](EulerFlashLoanAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](EulerFlashLoanAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](EulerFlashLoanAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](EulerFlashLoanAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](EulerFlashLoanAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](EulerFlashLoanAction.md#encodeforl2recipe)
- [encodeForRecipe](EulerFlashLoanAction.md#encodeforrecipe)
- [encodeForStrategy](EulerFlashLoanAction.md#encodeforstrategy)
- [getAccessList](EulerFlashLoanAction.md#getaccesslist)
- [getAssetsToApprove](EulerFlashLoanAction.md#getassetstoapprove)
- [getEthValue](EulerFlashLoanAction.md#getethvalue)
- [getId](EulerFlashLoanAction.md#getid)

## Constructors

### constructor

• **new EulerFlashLoanAction**(`tokenAddr`, `amount`, `flParamGetterAddr?`, `flParamGetterData?`)

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `tokenAddr` | `string` | `undefined` | {EthAddress} |
...
[src/actions/flashloan/EulerFlashLoanAction.ts:17](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/flashloan/EulerFlashLoanAction.ts#L17)
