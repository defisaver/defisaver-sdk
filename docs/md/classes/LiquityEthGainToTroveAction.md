[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquityEthGainToTroveAction

# Class: LiquityEthGainToTroveAction
...
- [constructor](LiquityEthGainToTroveAction.md#constructor)

### Properties

- [args](LiquityEthGainToTroveAction.md#args)
- [contractAddress](LiquityEthGainToTroveAction.md#contractaddress)
- [mappableArgs](LiquityEthGainToTroveAction.md#mappableargs)
- [name](LiquityEthGainToTroveAction.md#name)
- [paramTypes](LiquityEthGainToTroveAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquityEthGainToTroveAction.md#_encodeforcall)
- [\_formatType](LiquityEthGainToTroveAction.md#_formattype)
- [\_getArgumentMapping](LiquityEthGainToTroveAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquityEthGainToTroveAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquityEthGainToTroveAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquityEthGainToTroveAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquityEthGainToTroveAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquityEthGainToTroveAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquityEthGainToTroveAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquityEthGainToTroveAction.md#encodeforrecipe)
- [encodeForStrategy](LiquityEthGainToTroveAction.md#encodeforstrategy)
- [getAccessList](LiquityEthGainToTroveAction.md#getaccesslist)
- [getAssetsToApprove](LiquityEthGainToTroveAction.md#getassetstoapprove)
- [getEthValue](LiquityEthGainToTroveAction.md#getethvalue)
- [getId](LiquityEthGainToTroveAction.md#getid)

## Constructors

### constructor

• **new LiquityEthGainToTroveAction**(`lqtyTo`, `upperHint`, `lowerHint`)
...
[src/actions/liquity/LiquityEthGainToTroveAction.ts:14](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/liquity/LiquityEthGainToTroveAction.ts#L14)
