[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3ClaimRewardsAction

# Class: AaveV3ClaimRewardsAction
...
- [constructor](AaveV3ClaimRewardsAction.md#constructor)

### Properties

- [args](AaveV3ClaimRewardsAction.md#args)
- [contractAddress](AaveV3ClaimRewardsAction.md#contractaddress)
- [mappableArgs](AaveV3ClaimRewardsAction.md#mappableargs)
- [name](AaveV3ClaimRewardsAction.md#name)
- [paramTypes](AaveV3ClaimRewardsAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveV3ClaimRewardsAction.md#_encodeforcall)
- [\_formatType](AaveV3ClaimRewardsAction.md#_formattype)
- [\_getArgumentMapping](AaveV3ClaimRewardsAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveV3ClaimRewardsAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveV3ClaimRewardsAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveV3ClaimRewardsAction.md#_replacewithplaceholders)
- [addressToBytes20](AaveV3ClaimRewardsAction.md#addresstobytes20)
- [boolToBytes1](AaveV3ClaimRewardsAction.md#booltobytes1)
- [encodeForDsProxyCall](AaveV3ClaimRewardsAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveV3ClaimRewardsAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveV3ClaimRewardsAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveV3ClaimRewardsAction.md#encodeforrecipe)
- [encodeForStrategy](AaveV3ClaimRewardsAction.md#encodeforstrategy)
- [encodeInputs](AaveV3ClaimRewardsAction.md#encodeinputs)
- [getAccessList](AaveV3ClaimRewardsAction.md#getaccesslist)
- [getAssetsToApprove](AaveV3ClaimRewardsAction.md#getassetstoapprove)
- [getEthValue](AaveV3ClaimRewardsAction.md#getethvalue)
- [getId](AaveV3ClaimRewardsAction.md#getid)
- [numberToBytes1](AaveV3ClaimRewardsAction.md#numbertobytes1)
- [numberToBytes2](AaveV3ClaimRewardsAction.md#numbertobytes2)
- [numberToBytes32](AaveV3ClaimRewardsAction.md#numbertobytes32)

## Constructors

### constructor

• **new AaveV3ClaimRewardsAction**(`assetsLength`, `amount`, `to`, `reward`, `assets`)

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `assetsLength` | `string` | {number} Address provider for specific market |
| `amount` | `string` | {string} length of two arrays |
| `to` | `string` | {EthAddress} |
| `reward` | `string` | {EthAddress} |
| `assets` | `string`[] | {Array<EthAddress>} |
...
[src/actions/aaveV3/AaveV3ClaimRewardsAction.ts:20](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3ClaimRewardsAction.ts#L20)
...
[src/actions/aaveV3/AaveV3ClaimRewardsAction.ts:29](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3ClaimRewardsAction.ts#L29)
