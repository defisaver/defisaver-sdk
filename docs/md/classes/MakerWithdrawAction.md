[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerWithdrawAction
...
- [constructor](MakerWithdrawAction.md#constructor)

### Properties

- [args](MakerWithdrawAction.md#args)
- [contractAddress](MakerWithdrawAction.md#contractaddress)
- [mappableArgs](MakerWithdrawAction.md#mappableargs)
- [name](MakerWithdrawAction.md#name)
- [paramTypes](MakerWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerWithdrawAction.md#_encodeforcall)
- [\_formatType](MakerWithdrawAction.md#_formattype)
- [\_getArgumentMapping](MakerWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](MakerWithdrawAction.md#encodeforstrategy)
- [getAccessList](MakerWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](MakerWithdrawAction.md#getassetstoapprove)
- [getEthValue](MakerWithdrawAction.md#getethvalue)
- [getId](MakerWithdrawAction.md#getid)
...
[src/actions/maker/MakerWithdrawAction.ts:19](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerWithdrawAction.ts#L19)
