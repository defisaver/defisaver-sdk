[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveBorrowAction

# Class: AaveBorrowAction
...
- [constructor](AaveBorrowAction.md#constructor)

### Properties

- [args](AaveBorrowAction.md#args)
- [contractAddress](AaveBorrowAction.md#contractaddress)
- [mappableArgs](AaveBorrowAction.md#mappableargs)
- [name](AaveBorrowAction.md#name)
- [paramTypes](AaveBorrowAction.md#paramtypes)

### Methods

- [\_encodeForCall](AaveBorrowAction.md#_encodeforcall)
- [\_formatType](AaveBorrowAction.md#_formattype)
- [\_getArgumentMapping](AaveBorrowAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](AaveBorrowAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](AaveBorrowAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](AaveBorrowAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](AaveBorrowAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](AaveBorrowAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](AaveBorrowAction.md#encodeforl2recipe)
- [encodeForRecipe](AaveBorrowAction.md#encodeforrecipe)
- [encodeForStrategy](AaveBorrowAction.md#encodeforstrategy)
- [getAccessList](AaveBorrowAction.md#getaccesslist)
- [getAssetsToApprove](AaveBorrowAction.md#getassetstoapprove)
- [getEthValue](AaveBorrowAction.md#getethvalue)
- [getId](AaveBorrowAction.md#getid)
...
| `to` | `string` | Borrowed tokens will be sent to this address |
| `onBehalf` | `string` | Borrowing on behalf of address |
...
[src/actions/aave/AaveBorrowAction.ts:20](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aave/AaveBorrowAction.ts#L20)
