[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MStableDepositAction

# Class: MStableDepositAction
...
- [constructor](MStableDepositAction.md#constructor)

### Properties

- [args](MStableDepositAction.md#args)
- [contractAddress](MStableDepositAction.md#contractaddress)
- [mappableArgs](MStableDepositAction.md#mappableargs)
- [name](MStableDepositAction.md#name)
- [paramTypes](MStableDepositAction.md#paramtypes)

### Methods

- [\_encodeForCall](MStableDepositAction.md#_encodeforcall)
- [\_formatType](MStableDepositAction.md#_formattype)
- [\_getArgumentMapping](MStableDepositAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MStableDepositAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MStableDepositAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MStableDepositAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MStableDepositAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MStableDepositAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MStableDepositAction.md#encodeforl2recipe)
- [encodeForRecipe](MStableDepositAction.md#encodeforrecipe)
- [encodeForStrategy](MStableDepositAction.md#encodeforstrategy)
- [getAccessList](MStableDepositAction.md#getaccesslist)
- [getAssetsToApprove](MStableDepositAction.md#getassetstoapprove)
- [getEthValue](MStableDepositAction.md#getethvalue)
- [getId](MStableDepositAction.md#getid)
...
[src/actions/mstable/MStableDepositAction.ts:24](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/mstable/MStableDepositAction.ts#L24)
...
[src/actions/mstable/MStableDepositAction.ts:62](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/mstable/MStableDepositAction.ts#L62)
