[@defisaver/sdk](../README.md) / [Exports](../modules.md) / MakerGiveAction

# Class: MakerGiveAction
...
- [constructor](MakerGiveAction.md#constructor)

### Properties

- [args](MakerGiveAction.md#args)
- [contractAddress](MakerGiveAction.md#contractaddress)
- [mappableArgs](MakerGiveAction.md#mappableargs)
- [name](MakerGiveAction.md#name)
- [paramTypes](MakerGiveAction.md#paramtypes)

### Methods

- [\_encodeForCall](MakerGiveAction.md#_encodeforcall)
- [\_formatType](MakerGiveAction.md#_formattype)
- [\_getArgumentMapping](MakerGiveAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](MakerGiveAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](MakerGiveAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](MakerGiveAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](MakerGiveAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](MakerGiveAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](MakerGiveAction.md#encodeforl2recipe)
- [encodeForRecipe](MakerGiveAction.md#encodeforrecipe)
- [encodeForStrategy](MakerGiveAction.md#encodeforstrategy)
- [getAccessList](MakerGiveAction.md#getaccesslist)
- [getAssetsToApprove](MakerGiveAction.md#getassetstoapprove)
- [getEthValue](MakerGiveAction.md#getethvalue)
- [getId](MakerGiveAction.md#getid)
...
| `newOwner` | `string` | {EthAddress} |
| `createProxy` | `boolean` | {boolean} |
...
[src/actions/maker/MakerGiveAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/maker/MakerGiveAction.ts#L18)
