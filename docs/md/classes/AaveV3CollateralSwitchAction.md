[@defisaver/sdk](../README.md) / [Exports](../modules.md) / AaveV3CollateralSwitchAction
...
| `arrayLength` | `string` | {number} length of two arrays |
| `assetIds` | `string`[] | {Array<number>} |
| `useAsCollateral` | `boolean`[] | {Array<boolean>} |
...
[src/actions/aaveV3/AaveV3CollateralSwitchAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3CollateralSwitchAction.ts#L18)
...
[src/actions/aaveV3/AaveV3CollateralSwitchAction.ts:26](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/aaveV3/AaveV3CollateralSwitchAction.ts#L26)
