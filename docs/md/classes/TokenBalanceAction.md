[@defisaver/sdk](../README.md) / [Exports](../modules.md) / TokenBalanceAction

# Class: TokenBalanceAction
...
- [constructor](TokenBalanceAction.md#constructor)

### Properties

- [args](TokenBalanceAction.md#args)
- [contractAddress](TokenBalanceAction.md#contractaddress)
- [mappableArgs](TokenBalanceAction.md#mappableargs)
- [name](TokenBalanceAction.md#name)
- [paramTypes](TokenBalanceAction.md#paramtypes)

### Methods

- [\_encodeForCall](TokenBalanceAction.md#_encodeforcall)
- [\_formatType](TokenBalanceAction.md#_formattype)
- [\_getArgumentMapping](TokenBalanceAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](TokenBalanceAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](TokenBalanceAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](TokenBalanceAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](TokenBalanceAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](TokenBalanceAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](TokenBalanceAction.md#encodeforl2recipe)
- [encodeForRecipe](TokenBalanceAction.md#encodeforrecipe)
- [encodeForStrategy](TokenBalanceAction.md#encodeforstrategy)
- [getAccessList](TokenBalanceAction.md#getaccesslist)
- [getAssetsToApprove](TokenBalanceAction.md#getassetstoapprove)
- [getEthValue](TokenBalanceAction.md#getethvalue)
- [getId](TokenBalanceAction.md#getid)

## Constructors

### constructor

• **new TokenBalanceAction**(`tokenAddr`, `holderAddr`)
...
[src/actions/basic/TokenBalanceAction.ts:9](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/basic/TokenBalanceAction.ts#L9)
