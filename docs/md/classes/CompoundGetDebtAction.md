[@defisaver/sdk](../README.md) / [Exports](../modules.md) / CompoundGetDebtAction

# Class: CompoundGetDebtAction
...
- [constructor](CompoundGetDebtAction.md#constructor)

### Properties

- [args](CompoundGetDebtAction.md#args)
- [contractAddress](CompoundGetDebtAction.md#contractaddress)
- [mappableArgs](CompoundGetDebtAction.md#mappableargs)
- [name](CompoundGetDebtAction.md#name)
- [paramTypes](CompoundGetDebtAction.md#paramtypes)

### Methods

- [\_encodeForCall](CompoundGetDebtAction.md#_encodeforcall)
- [\_formatType](CompoundGetDebtAction.md#_formattype)
- [\_getArgumentMapping](CompoundGetDebtAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](CompoundGetDebtAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](CompoundGetDebtAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](CompoundGetDebtAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](CompoundGetDebtAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](CompoundGetDebtAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](CompoundGetDebtAction.md#encodeforl2recipe)
- [encodeForRecipe](CompoundGetDebtAction.md#encodeforrecipe)
- [encodeForStrategy](CompoundGetDebtAction.md#encodeforstrategy)
- [getAccessList](CompoundGetDebtAction.md#getaccesslist)
- [getAssetsToApprove](CompoundGetDebtAction.md#getassetstoapprove)
- [getEthValue](CompoundGetDebtAction.md#getethvalue)
- [getId](CompoundGetDebtAction.md#getid)

## Constructors

### constructor

• **new CompoundGetDebtAction**(`cTokenAddr`, `holderAddr`)
...
[src/actions/compound/CompoundGetDebtAction.ts:10](https://github.com/defisaver/defisaver-sdk/blob/7ebb702/src/actions/compound/CompoundGetDebtAction.ts#L10)
