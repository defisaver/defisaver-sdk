[@defisaver/sdk](../README.md) / [Exports](../modules.md) / LiquitySPWithdrawAction

# Class: LiquitySPWithdrawAction
...
- [`Action`](Action.md)
  ...
  ↳↳ [`LiquityClaimSPRewardsAction`](LiquityClaimSPRewardsAction.md)

## Table of contents

### Constructors

- [constructor](LiquitySPWithdrawAction.md#constructor)

### Properties

- [args](LiquitySPWithdrawAction.md#args)
- [contractAddress](LiquitySPWithdrawAction.md#contractaddress)
- [mappableArgs](LiquitySPWithdrawAction.md#mappableargs)
- [name](LiquitySPWithdrawAction.md#name)
- [paramTypes](LiquitySPWithdrawAction.md#paramtypes)

### Methods

- [\_encodeForCall](LiquitySPWithdrawAction.md#_encodeforcall)
- [\_formatType](LiquitySPWithdrawAction.md#_formattype)
- [\_getArgumentMapping](LiquitySPWithdrawAction.md#_getargumentmapping)
- [\_getArgumentMappingWithSlots](LiquitySPWithdrawAction.md#_getargumentmappingwithslots)
- [\_getPlaceholderForType](LiquitySPWithdrawAction.md#_getplaceholderfortype)
- [\_replaceWithPlaceholders](LiquitySPWithdrawAction.md#_replacewithplaceholders)
- [encodeForDsProxyCall](LiquitySPWithdrawAction.md#encodefordsproxycall)
- [encodeForL2DsProxyCall](LiquitySPWithdrawAction.md#encodeforl2dsproxycall)
- [encodeForL2Recipe](LiquitySPWithdrawAction.md#encodeforl2recipe)
- [encodeForRecipe](LiquitySPWithdrawAction.md#encodeforrecipe)
- [encodeForStrategy](LiquitySPWithdrawAction.md#encodeforstrategy)
- [getAccessList](LiquitySPWithdrawAction.md#getaccesslist)
- [getAssetsToApprove](LiquitySPWithdrawAction.md#getassetstoapprove)
- [getEthValue](LiquitySPWithdrawAction.md#getethvalue)
- [getId](LiquitySPWithdrawAction.md#getid)
...
| :------ | :------ | :------ |
| `lusdAmount` | `string` | Amount of LUSD tokens to withdraw |
| `to` | `string` | Address that will receive the LUSD tokens |
...
[src/actions/liquity/LiquitySPWithdrawAction.ts:18](https://github.com/defisaver/defisaver-sdk/blob/4146181/src/actions/liquity/LiquitySPWithdrawAction.ts#L18)
