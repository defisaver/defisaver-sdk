...
class UniswapV3CreatePoolAction extends Action {
  ...
  async getAssetsToApprove() {
    ...
    if (assetA.symbol !== 'ETH') approveArr.push({asset: this.args[0][0], owner: this.args[0][11], protocol: 'uniswap v3'});
    if (assetB.symbol !== 'ETH') approveArr.push({asset: this.args[0][1], owner: this.args[0][11], protocol: 'uniswap v3'});
