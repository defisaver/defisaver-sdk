...
export class LimitSellActionL2 extends ActionWithL2 {
   ...
   * @param l1GasUsed Amount of L1 gasUsed for L2 chains
   * @param protocolFee 0x fee (amount of ETH in Wei)
   */
  constructor(exchangeOrder:Array<any>, from:EthAddress, to:EthAddress, gasUsed: uint256, l1GasUsed: uint256, protocolFee = '0') {
    requireAddress(to);
    super(
      'LimitSellL2',
      getAddr('LimitSellL2'),
      ...
      [exchangeOrder, from, to, gasUsed, l1GasUsed],
    );
