...
class UniswapSupplyAction extends Action {
  ...
  async getAssetsToApprove() {
    ...
    if (assetA.symbol !== 'ETH') approveArr.push({asset: this.args[0][0], owner: this.args[0][2], protocol: 'uniswap v2'});
    if (assetB.symbol !== 'ETH') approveArr.push({asset: this.args[0][1], owner: this.args[0][2], protocol: 'uniswap v2'});
