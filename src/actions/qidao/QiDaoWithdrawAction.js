...
/**
 * QiDaoWithdrawAction - Withdraw collateral from QiDao vault
 */
class QiDaoWithdrawAction extends ActionWithL2 {
  /**
   ...
   * @param to {EthAddress} address to which to send withdrawn collateral
   */
  constructor(vaultId, userVaultId, amount, to) {
    super('QiDaoWithdraw',
    '0', //TODO :  getAddr('QiDaoWithdraw')
...
module.exports = QiDaoWithdrawAction;
