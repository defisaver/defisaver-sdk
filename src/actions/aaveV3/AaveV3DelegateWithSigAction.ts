...
/**
 * AaveV3DelegateWithSigCredit - Delegate credit on someone elses behalf with their signature
 *
 * @category AaveV3
 */
export class AaveV3DelegateWithSigCredit extends ActionWithL2 {
  constructor(debtToken: EthAddress, delegator: EthAddress, delegatee: EthAddress, value: uint256, deadline: uint256, v: uint8, r: bytes32, s: bytes32) {
    super('AaveV3DelegateWithSig', getAddr('AaveV3DelegateWithSig'),
